...
public class DeleteInspectionTaskInfoListener extends AbstractInspectionTaskBusinessServiceDataFlowListener {
    ...
    protected void doSaveBusiness(DataFlowContext dataFlowContext, Business business) {
        ...
        if (data.containsKey(BusinessTypeConstant.BUSINESS_TYPE_DELETE_INSPECTION_TASK)) {
            Object _obj = data.get(BusinessTypeConstant.BUSINESS_TYPE_DELETE_INSPECTION_TASK);
