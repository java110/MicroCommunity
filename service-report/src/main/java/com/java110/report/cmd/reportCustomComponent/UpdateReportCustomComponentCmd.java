...
/**
 * 类表述：更新
 * 服务编码：reportCustomComponent.updateReportCustomComponent
 * 请求路劲：/app/reportCustomComponent.UpdateReportCustomComponent
 ...
 */
@Java110Cmd(serviceCode = "reportCustomComponent.updateReportCustomComponent")
public class UpdateReportCustomComponentCmd extends AbstractServiceCmdListener {

    private static Logger logger = LoggerFactory.getLogger(UpdateReportCustomComponentCmd.class);
