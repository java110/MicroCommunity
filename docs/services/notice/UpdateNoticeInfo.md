...
###### URL
> [http://notice-service/noticeApi/service](http://notice-service/noticeApi/service)
...
|datas|businessNoticeInfo|1|Object|-|小区成员|小区成员|
|businessNoticeInfo|noticeTypeCd|1|String|30|-|-|
|businessNoticeInfo|context|1|String|30|-|-|
|businessNoticeInfo|startTime|1|String|30|-|-|
|businessNoticeInfo|communityId|1|String|30|-|-|
|businessNoticeInfo|title|1|String|30|-|-|
|businessNoticeInfo|userId|1|String|30|-|-|
|businessNoticeInfo|noticeId|1|String|30|-|-|
...
###### 举例
> 地址：[http://notice-service/noticeApi/service](http://notice-service/noticeApi/service)
