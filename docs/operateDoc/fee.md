...
关于一些动态费用 如 小区公摊电费 小区公摊水费，每个小区计算方式不太一样，有的按房屋面积公摊 有的按户数公摊，有的
按层数 是否有电梯等的公摊方式，计算比较复杂，这里提供费用导入的方式来解决
我们可以在Excel中根据公式计算出每户应该公摊所收取的费用，导入系统 进行收费
...
填写 费用名称 开始时间 结束时间 收费金额 后将模板导入即可
