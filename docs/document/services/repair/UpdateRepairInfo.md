...
###### URL
> [http://repair-service/repairApi/service](http://repair-service/repairApi/service)
...
|datas|businessRepairInfo|1|Object|-|小区成员|小区成员|
|businessRepairInfo|repairName|1|String|30|-|-|
|businessRepairInfo|appointmentTime|1|String|30|-|-|
|businessRepairInfo|repairType|1|String|30|-|-|
|businessRepairInfo|context|1|String|30|-|-|
|businessRepairInfo|repairId|1|String|30|-|-|
|businessRepairInfo|tel|1|String|30|-|-|
|businessRepairInfo|state|1|String|30|-|-|
|businessRepairInfo|communityId|1|String|30|-|-|
|businessRepairInfo|roomId|1|String|30|-|-|
...
###### 举例
> 地址：[http://repair-service/repairApi/service](http://repair-service/repairApi/service)
...

{
  ...
  "business": {
    "businessTypeCd": "130100040001",
    "bId":"1234567892",
    "remark": "备注",
    "datas": {
      "businessRepairInfo": {
                "repairName":"填写具体值",
        "appointmentTime":"填写具体值",
        "repairType":"填写具体值",
        "context":"填写具体值",
        "repairId":"填写具体值",
        "tel":"填写具体值",
