...
###### URL
> [http://repairUser-service/repairUserApi/service](http://repairUser-service/repairUserApi/service)
...
|datas|businessRepairUserInfo|1|Object|-|小区成员|小区成员|
|businessRepairUserInfo|context|1|String|30|-|-|
|businessRepairUserInfo|repairId|1|String|30|-|-|
|businessRepairUserInfo|ruId|1|String|30|-|-|
|businessRepairUserInfo|state|1|String|30|-|-|
|businessRepairUserInfo|communityId|1|String|30|-|-|
|businessRepairUserInfo|userId|1|String|30|-|-|
...
###### 举例
> 地址：[http://repairUser-service/repairUserApi/service](http://repairUser-service/repairUserApi/service)
...

{
  ...
  "business": {
    "businessTypeCd": "130200040001",
    "bId":"1234567892",
    "remark": "备注",
    "datas": {
      "businessRepairUserInfo": {
                "context":"填写具体值",
        "repairId":"填写具体值",
        "ruId":"填写具体值",
        "state":"填写具体值",
