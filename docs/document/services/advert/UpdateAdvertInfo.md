...
###### URL
> [http://advert-service/advertApi/service](http://advert-service/advertApi/service)
...
|datas|businessAdvertInfo|1|Object|-|小区成员|小区成员|
|businessAdvertInfo|classify|1|String|30|-|-|
|businessAdvertInfo|adName|1|String|30|-|-|
|businessAdvertInfo|locationTypeCd|1|String|30|-|-|
|businessAdvertInfo|adTypeCd|1|String|30|-|-|
|businessAdvertInfo|advertId|1|String|30|-|-|
|businessAdvertInfo|startTime|1|String|30|-|-|
|businessAdvertInfo|state|1|String|30|-|-|
|businessAdvertInfo|endTime|1|String|30|-|-|
|businessAdvertInfo|communityId|1|String|30|-|-|
|businessAdvertInfo|locationObjId|1|String|30|-|-|
|businessAdvertInfo|seq|1|String|30|-|-|
...
###### 举例
> 地址：[http://advert-service/advertApi/service](http://advert-service/advertApi/service)
