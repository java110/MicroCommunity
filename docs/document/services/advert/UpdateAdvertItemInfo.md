...
###### URL
> [http://advertItem-service/advertItemApi/service](http://advertItem-service/advertItemApi/service)
...
|datas|businessAdvertItemInfo|1|Object|-|小区成员|小区成员|
|businessAdvertItemInfo|itemTypeCd|1|String|30|-|-|
|businessAdvertItemInfo|communityId|1|String|30|-|-|
|businessAdvertItemInfo|advertItemId|1|String|30|-|-|
|businessAdvertItemInfo|advertId|1|String|30|-|-|
|businessAdvertItemInfo|url|1|String|30|-|-|
|businessAdvertItemInfo|seq|1|String|30|-|-|
...
###### 举例
> 地址：[http://advertItem-service/advertItemApi/service](http://advertItem-service/advertItemApi/service)
...

{
  ...
  "business": {
    "businessTypeCd": "271200040001",
    "bId":"1234567892",
    "remark": "备注",
    "datas": {
      "businessAdvertItemInfo": {
                "itemTypeCd":"填写具体值",
        "communityId":"填写具体值",
        "advertItemId":"填写具体值",
        "advertId":"填写具体值",
