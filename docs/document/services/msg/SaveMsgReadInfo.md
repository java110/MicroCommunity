...
###### URL
> [http://msgRead-service/msgReadApi/service](http://msgRead-service/msgReadApi/service)
...
|datas|businessMsgReadInfo|1|Object|-|小区成员|小区成员|
|businessMsgReadInfo|msgReadId|1|String|30|-|-|
|businessMsgReadInfo|msgId|1|String|30|-|-|
|businessMsgReadInfo|userName|1|String|30|-|-|
|businessMsgReadInfo|userId|1|String|30|-|-|
...
###### 举例
> 地址：[http://msgRead-service/msgReadApi/service](http://msgRead-service/msgReadApi/service)
