...
###### URL
> [http://inspection-service/inspectionApi/service](http://inspection-service/inspectionApi/service)
...
|datas|businessInspectionInfo|1|Object|-|小区成员|小区成员|
|businessInspectionInfo|inspectionId|1|String|30|-|-|
|businessInspectionInfo|machineId|1|String|30|-|-|
|businessInspectionInfo|remark|1|String|30|-|-|
|businessInspectionInfo|inspectionName|1|String|30|-|-|
|businessInspectionInfo|communityId|1|String|30|-|-|
...
###### 举例
> 地址：[http://inspection-service/inspectionApi/service](http://inspection-service/inspectionApi/service)
...

{
  ...
  "business": {
    "businessTypeCd": "300200030001",
    "bId":"1234567892",
    "remark": "备注",
    "datas": {
      "businessInspectionInfo": {
                "inspectionId":"填写具体值",
        "machineId":"填写具体值",
        "remark":"填写具体值",
        "inspectionName":"填写具体值",
        "communityId":"填写具体值"
      }
    },
    "attrs": [{
