 ...
 */
@Java110Listener("saveServiceImplListener")
public class SaveServiceImplListener extends AbstractServiceApiListener {
    ...
    public String getServiceCode() {
        return ServiceCodeServiceImplConstant.ADD_SERVICEIMPL;
    }
