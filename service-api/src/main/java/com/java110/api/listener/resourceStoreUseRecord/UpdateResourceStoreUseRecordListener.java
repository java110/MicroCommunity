 ...
 */
@Java110Listener("updateResourceStoreUseRecordListener")
public class UpdateResourceStoreUseRecordListener extends AbstractServiceApiPlusListener {
    ...
    protected void doSoService(ServiceDataFlowEvent event, DataFlowContext context, JSONObject reqJson) {
        ...
        resourceStoreUseRecordBMOImpl.updateResourceStoreUseRecord(reqJson, context);
    }

    @Override
    public String getServiceCode() {
        return ServiceCodeResourceStoreUseRecordConstant.UPDATE_RESOURCESTOREUSERECORD;
    }
