 ...
 **/
@Component
public class TranslateVisitPhotoToMachine extends TaskSystemQuartz {

    private static Logger logger = LoggerFactory.getLogger(TranslateVisitPhotoToMachine.class);
