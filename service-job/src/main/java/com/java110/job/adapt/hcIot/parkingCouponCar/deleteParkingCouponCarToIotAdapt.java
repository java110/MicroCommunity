 ...
 */
@Component(value = "deleteParkingCouponCarToIotAdapt")
public class deleteParkingCouponCarToIotAdapt extends DatabusAdaptImpl {
    ...
    private void doSendParkingCouponCar(Business business, JSONObject businessTempCarFeeConfig) {
        ...
        postParameters.put("extPccId", parkingCouponCarPo.getPccId());

        hcTempCarFeeConfigAsynImpl.deleteParkingCouponCar(postParameters);
    }
}
