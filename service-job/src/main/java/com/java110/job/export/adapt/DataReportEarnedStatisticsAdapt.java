...
@Service("dataReportEarnedStatistics")
public class DataReportEarnedStatisticsAdapt implements IExportDataAdapt {
    ...
    public SXSSFWorkbook exportData(ExportDataDto exportDataDto) {
        ...
        Sheet sheet = workbook.createSheet("实收统计");
        ...
        List<Map> datas = null;
        // todo 按楼栋计算实收情况
        datas = reportFeeStatisticsInnerServiceSMOImpl.getReceivedFeeByFloor(queryStatisticsDto);
