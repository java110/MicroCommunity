...
@RequestMapping("/workTypeV1Api")
public interface IWorkTypeV1InnerServiceSMO {
     ...
     */
    @RequestMapping(value = "/queryWorkTypes", method = RequestMethod.POST)
    List<WorkTypeDto> queryWorkTypes(@RequestBody WorkTypeDto workTypeDto);
     ...
     * @return 小区下的小区楼记录数
     */
    @RequestMapping(value = "/queryWorkTypesCount", method = RequestMethod.POST)
    int queryWorkTypesCount(@RequestBody WorkTypeDto workTypeDto);
}
