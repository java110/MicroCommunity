...
@RequestMapping("/integralSettingV1Api")
public interface IIntegralSettingV1InnerServiceSMO {
    ...
    @RequestMapping(value = "/deleteIntegralSetting", method = RequestMethod.POST)
     ...
     *
     *
     * @param integralSettingDto 数据对象分享
     * @return IntegralSettingDto 对象数据
     */
    @RequestMapping(value = "/queryIntegralSettings", method = RequestMethod.POST)
    List<IntegralSettingDto> queryIntegralSettings(@RequestBody IntegralSettingDto integralSettingDto);
     ...
     * @return 小区下的小区楼记录数
     */
    @RequestMapping(value = "/queryIntegralSettingsCount", method = RequestMethod.POST)
    int queryIntegralSettingsCount(@RequestBody IntegralSettingDto integralSettingDto);
}
