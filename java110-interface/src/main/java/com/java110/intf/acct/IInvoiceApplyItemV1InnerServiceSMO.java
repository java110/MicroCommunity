...
@RequestMapping("/invoiceApplyItemV1Api")
public interface IInvoiceApplyItemV1InnerServiceSMO {
    ...
    @RequestMapping(value = "/deleteInvoiceApplyItem", method = RequestMethod.POST)
    public int deleteInvoiceApplyItem(@RequestBody  InvoiceApplyItemPo invoiceApplyItemPo);

    /**
     * <p>查询小区楼信息</p>
     *
     *
     * @param invoiceApplyItemDto 数据对象分享
     * @return InvoiceApplyItemDto 对象数据
     */
    @RequestMapping(value = "/queryInvoiceApplyItems", method = RequestMethod.POST)
    List<InvoiceApplyItemDto> queryInvoiceApplyItems(@RequestBody InvoiceApplyItemDto invoiceApplyItemDto);
