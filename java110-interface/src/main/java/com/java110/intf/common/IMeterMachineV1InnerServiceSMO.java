...
@RequestMapping("/meterMachineV1Api")
public interface IMeterMachineV1InnerServiceSMO {


    @RequestMapping(value = "/saveMeterMachine", method = RequestMethod.POST)
    public int saveMeterMachine(@RequestBody  MeterMachinePo meterMachinePo);

    @RequestMapping(value = "/updateMeterMachine", method = RequestMethod.POST)
    public int updateMeterMachine(@RequestBody  MeterMachinePo meterMachinePo);

    @RequestMapping(value = "/deleteMeterMachine", method = RequestMethod.POST)
     ...
     * @return MeterMachineDto 对象数据
     */
    @RequestMapping(value = "/queryMeterMachines", method = RequestMethod.POST)
    List<MeterMachineDto> queryMeterMachines(@RequestBody MeterMachineDto meterMachineDto);
