...
@RequestMapping("/auditUserV1Api")
public interface IAuditUserV1InnerServiceSMO {


    @RequestMapping(value = "/saveAuditUser", method = RequestMethod.POST)
    public int saveAuditUser(@RequestBody AuditUserPo auditUserPo);

    @RequestMapping(value = "/updateAuditUser", method = RequestMethod.POST)
