...
@RequestMapping("/workflowStepStaffV1Api")
public interface IWorkflowStepStaffV1InnerServiceSMO {


    @RequestMapping(value = "/saveWorkflowStepStaff", method = RequestMethod.POST)
    public int saveWorkflowStepStaff(@RequestBody WorkflowStepStaffPo workflowStepStaffPo);

    @RequestMapping(value = "/updateWorkflowStepStaff", method = RequestMethod.POST)
    public int updateWorkflowStepStaff(@RequestBody  WorkflowStepStaffPo workflowStepStaffPo);

    @RequestMapping(value = "/deleteWorkflowStepStaff", method = RequestMethod.POST)
