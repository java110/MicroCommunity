...
@RequestMapping("/notifySmartWeterV1Api")
public interface INotifySmartMeterV1InnerServiceSMO {
     ...
     * @return 小区下的小区楼记录数
     */
    @RequestMapping(value = "/notifySmartMater", method = RequestMethod.POST)
