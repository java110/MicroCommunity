...
@RequestMapping("/itemReleaseResV1Api")
public interface IItemReleaseResV1InnerServiceSMO {
    ...
    @RequestMapping(value = "/deleteItemReleaseRes", method = RequestMethod.POST)
     ...
     *
     *
     * @param itemReleaseResDto 数据对象分享
     * @return ItemReleaseResDto 对象数据
     */
    @RequestMapping(value = "/queryItemReleaseRess", method = RequestMethod.POST)
    List<ItemReleaseResDto> queryItemReleaseRess(@RequestBody ItemReleaseResDto itemReleaseResDto);
     ...
     * @return 小区下的小区楼记录数
     */
    @RequestMapping(value = "/queryItemReleaseRessCount", method = RequestMethod.POST)
    int queryItemReleaseRessCount(@RequestBody ItemReleaseResDto itemReleaseResDto);
}
