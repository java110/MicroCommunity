...
@RequestMapping("/marketGoodsItemV1Api")
public interface IMarketGoodsItemV1InnerServiceSMO {


    @RequestMapping(value = "/saveMarketGoodsItem", method = RequestMethod.POST)
    public int saveMarketGoodsItem(@RequestBody MarketGoodsItemPo marketGoodsItemPo);

    @RequestMapping(value = "/updateMarketGoodsItem", method = RequestMethod.POST)
    public int updateMarketGoodsItem(@RequestBody MarketGoodsItemPo marketGoodsItemPo);

    @RequestMapping(value = "/deleteMarketGoodsItem", method = RequestMethod.POST)
     ...
     *
     *
     * @param marketGoodsItemDto 数据对象分享
     * @return MarketGoodsItemDto 对象数据
     */
    @RequestMapping(value = "/queryMarketGoodsItems", method = RequestMethod.POST)
    List<MarketGoodsItemDto> queryMarketGoodsItems(@RequestBody MarketGoodsItemDto marketGoodsItemDto);
