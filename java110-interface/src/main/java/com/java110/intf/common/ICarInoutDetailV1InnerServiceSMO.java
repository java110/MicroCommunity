...
@RequestMapping("/carInoutDetailV1Api")
public interface ICarInoutDetailV1InnerServiceSMO {


    @RequestMapping(value = "/saveCarInoutDetail", method = RequestMethod.POST)
    public int saveCarInoutDetail(@RequestBody CarInoutDetailPo carInoutDetailPo);

    @RequestMapping(value = "/updateCarInoutDetail", method = RequestMethod.POST)
    public int updateCarInoutDetail(@RequestBody  CarInoutDetailPo carInoutDetailPo);

    @RequestMapping(value = "/deleteCarInoutDetail", method = RequestMethod.POST)
