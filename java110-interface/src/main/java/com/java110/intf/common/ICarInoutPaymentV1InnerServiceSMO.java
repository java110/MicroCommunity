...
@RequestMapping("/carInoutPaymentV1Api")
public interface ICarInoutPaymentV1InnerServiceSMO {


    @RequestMapping(value = "/saveCarInoutPayment", method = RequestMethod.POST)
    public int saveCarInoutPayment(@RequestBody  CarInoutPaymentPo carInoutPaymentPo);

    @RequestMapping(value = "/updateCarInoutPayment", method = RequestMethod.POST)
    public int updateCarInoutPayment(@RequestBody  CarInoutPaymentPo carInoutPaymentPo);

    @RequestMapping(value = "/deleteCarInoutPayment", method = RequestMethod.POST)
     ...
     *
     *
     * @param carInoutPaymentDto 数据对象分享
     * @return CarInoutPaymentDto 对象数据
     */
    @RequestMapping(value = "/queryCarInoutPayments", method = RequestMethod.POST)
    List<CarInoutPaymentDto> queryCarInoutPayments(@RequestBody CarInoutPaymentDto carInoutPaymentDto);
