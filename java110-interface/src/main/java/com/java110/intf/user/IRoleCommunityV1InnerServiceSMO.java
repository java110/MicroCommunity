...
@RequestMapping("/roleCommunityV1Api")
public interface IRoleCommunityV1InnerServiceSMO {


    @RequestMapping(value = "/saveRoleCommunity", method = RequestMethod.POST)
    public int saveRoleCommunity(@RequestBody  RoleCommunityPo roleCommunityPo);

    @RequestMapping(value = "/updateRoleCommunity", method = RequestMethod.POST)
    public int updateRoleCommunity(@RequestBody  RoleCommunityPo roleCommunityPo);

    @RequestMapping(value = "/deleteRoleCommunity", method = RequestMethod.POST)
     ...
     *
     *
     * @param roleCommunityDto 数据对象分享
     * @return RoleCommunityDto 对象数据
     */
    @RequestMapping(value = "/queryRoleCommunitys", method = RequestMethod.POST)
    List<RoleCommunityDto> queryRoleCommunitys(@RequestBody RoleCommunityDto roleCommunityDto);
