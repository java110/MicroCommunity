...
public interface IDataPrivilegeStaffV1InnerServiceSMO {
    ...
    @RequestMapping(value = "/saveDataPrivilegeStaff", method = RequestMethod.POST)
    public int saveDataPrivilegeStaff(@RequestBody DataPrivilegeStaffPo dataPrivilegeStaffPo);

    @RequestMapping(value = "/updateDataPrivilegeStaff", method = RequestMethod.POST)
    public int updateDataPrivilegeStaff(@RequestBody DataPrivilegeStaffPo dataPrivilegeStaffPo);

    @RequestMapping(value = "/deleteDataPrivilegeStaff", method = RequestMethod.POST)
     ...
     *
     *
     * @param dataPrivilegeStaffDto 数据对象分享
     * @return DataPrivilegeStaffDto 对象数据
     */
    @RequestMapping(value = "/queryDataPrivilegeStaffs", method = RequestMethod.POST)
    List<DataPrivilegeStaffDto> queryDataPrivilegeStaffs(@RequestBody DataPrivilegeStaffDto dataPrivilegeStaffDto);
