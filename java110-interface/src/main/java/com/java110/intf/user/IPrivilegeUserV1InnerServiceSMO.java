...
@RequestMapping("/privilegeUserV1Api")
public interface IPrivilegeUserV1InnerServiceSMO {
    ...
    List<PrivilegeUserDto> queryPrivilegeUsers(@RequestBody PrivilegeUserDto privilegeUserDto);
