...
@RequestMapping("/payFeeRuleV1Api")
public interface IPayFeeRuleV1InnerServiceSMO {
    ...
    @RequestMapping(value = "/deletePayFeeRule", method = RequestMethod.POST)
     int deletePayFeeRule(@RequestBody  PayFeeRulePo payFeeRulePo);

    /**
     * <p>查询小区楼信息</p>
     *
     *
     * @param payFeeRuleDto 数据对象分享
     * @return PayFeeRuleDto 对象数据
     */
    @RequestMapping(value = "/queryPayFeeRules", method = RequestMethod.POST)
    List<PayFeeRuleDto> queryPayFeeRules(@RequestBody PayFeeRuleDto payFeeRuleDto);
