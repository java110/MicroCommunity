...
@RequestMapping("/maintainanceTaskV1Api")
public interface IMaintainanceTaskV1InnerServiceSMO {
    ...
    @RequestMapping(value = "/updateMaintainanceTask", method = RequestMethod.POST)
    public int updateMaintainanceTask(@RequestBody MaintainanceTaskPo maintainanceTaskPo);

    @RequestMapping(value = "/deleteMaintainanceTask", method = RequestMethod.POST)
     ...
     *
     *
     * @param maintainanceTaskDto 数据对象分享
     * @return MaintainanceTaskDto 对象数据
     */
    @RequestMapping(value = "/queryMaintainanceTasks", method = RequestMethod.POST)
    List<MaintainanceTaskDto> queryMaintainanceTasks(@RequestBody MaintainanceTaskDto maintainanceTaskDto);
