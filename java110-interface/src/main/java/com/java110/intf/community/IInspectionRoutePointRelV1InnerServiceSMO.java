...
@RequestMapping("/inspectionRoutePointRelV1Api")
public interface IInspectionRoutePointRelV1InnerServiceSMO {


    @RequestMapping(value = "/saveInspectionRoutePointRel", method = RequestMethod.POST)
    public int saveInspectionRoutePointRel(@RequestBody InspectionRoutePointRelPo inspectionRoutePointRelPo);

    @RequestMapping(value = "/updateInspectionRoutePointRel", method = RequestMethod.POST)
    public int updateInspectionRoutePointRel(@RequestBody  InspectionRoutePointRelPo inspectionRoutePointRelPo);

    @RequestMapping(value = "/deleteInspectionRoutePointRel", method = RequestMethod.POST)
