...
@RequestMapping("/inspectionPlanStaffV1Api")
public interface IInspectionPlanStaffV1InnerServiceSMO {


    @RequestMapping(value = "/saveInspectionPlanStaff", method = RequestMethod.POST)
    public int saveInspectionPlanStaff(@RequestBody InspectionPlanStaffPo inspectionPlanStaffPo);

    @RequestMapping(value = "/updateInspectionPlanStaff", method = RequestMethod.POST)
    public int updateInspectionPlanStaff(@RequestBody InspectionPlanStaffPo inspectionPlanStaffPo);

    @RequestMapping(value = "/deleteInspectionPlanStaff", method = RequestMethod.POST)
