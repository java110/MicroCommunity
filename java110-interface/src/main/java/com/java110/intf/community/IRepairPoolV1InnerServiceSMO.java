...
public interface IRepairPoolV1InnerServiceSMO {
    ...
    @RequestMapping(value = "/updateRepairPoolNew", method = RequestMethod.POST)
...
//     *
//     *
//     * @param repairPoolNewDto 数据对象分享
//     * @return RepairPoolNewDto 对象数据
//     */
//    @RequestMapping(value = "/queryRepairPoolNews", method = RequestMethod.POST)
//    List<RepairPoolDto> queryRepairPoolNews(@RequestBody RepairPoolDto repairPoolNewDto);
//
//    /**
//     * 查询<p>小区楼</p>总记录数
//     *
...
//     * @return 小区下的小区楼记录数
//     */
//    @RequestMapping(value = "/queryRepairPoolNewsCount", method = RequestMethod.POST)
//    int queryRepairPoolNewsCount(@RequestBody RepairPoolDto repairPoolNewDto);
}
