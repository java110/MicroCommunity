...
@RequestMapping("/inspectionTaskDetailV1Api")
public interface IInspectionTaskDetailV1InnerServiceSMO {
    ...
    @RequestMapping(value = "/deleteInspectionTaskDetail", method = RequestMethod.POST)
