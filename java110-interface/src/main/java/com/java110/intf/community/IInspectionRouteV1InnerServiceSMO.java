...
@RequestMapping("/inspectionRouteV1Api")
public interface IInspectionRouteV1InnerServiceSMO {


    @RequestMapping(value = "/saveInspectionRoute", method = RequestMethod.POST)
    public int saveInspectionRoute(@RequestBody InspectionRoutePo inspectionRoutePo);

    @RequestMapping(value = "/updateInspectionRoute", method = RequestMethod.POST)
    public int updateInspectionRoute(@RequestBody InspectionRoutePo inspectionRoutePo);

    @RequestMapping(value = "/deleteInspectionRoute", method = RequestMethod.POST)
