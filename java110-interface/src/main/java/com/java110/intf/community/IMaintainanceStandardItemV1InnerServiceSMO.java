...
@RequestMapping("/maintainanceStandardItemV1Api")
public interface IMaintainanceStandardItemV1InnerServiceSMO {


    @RequestMapping(value = "/saveMaintainanceStandardItem", method = RequestMethod.POST)
    public int saveMaintainanceStandardItem(@RequestBody MaintainanceStandardItemPo maintainanceStandardItemPo);

    @RequestMapping(value = "/updateMaintainanceStandardItem", method = RequestMethod.POST)
    public int updateMaintainanceStandardItem(@RequestBody MaintainanceStandardItemPo maintainanceStandardItemPo);

    @RequestMapping(value = "/deleteMaintainanceStandardItem", method = RequestMethod.POST)
     ...
     *
     *
     * @param maintainanceStandardItemDto 数据对象分享
     * @return MaintainanceStandardItemDto 对象数据
     */
    @RequestMapping(value = "/queryMaintainanceStandardItems", method = RequestMethod.POST)
    List<MaintainanceStandardItemDto> queryMaintainanceStandardItems(@RequestBody MaintainanceStandardItemDto maintainanceStandardItemDto);
