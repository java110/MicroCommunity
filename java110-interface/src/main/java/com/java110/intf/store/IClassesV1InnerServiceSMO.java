...
@RequestMapping("/classesV1Api")
public interface IClassesV1InnerServiceSMO {
     ...
     *
     *
     * @param classesDto 数据对象分享
     * @return ClassesDto 对象数据
     */
    @RequestMapping(value = "/queryClassess", method = RequestMethod.POST)
    List<ClassesDto> queryClassess(@RequestBody ClassesDto classesDto);
     ...
     * @return 小区下的小区楼记录数
     */
    @RequestMapping(value = "/queryClassessCount", method = RequestMethod.POST)
    int queryClassessCount(@RequestBody ClassesDto classesDto);
}
