...
@RequestMapping("/resourceResourceStoreTypeTypeV1Api")
public interface IResourceStoreTypeV1InnerServiceSMO {


    @RequestMapping(value = "/saveResourceStoreType", method = RequestMethod.POST)
    public int saveResourceStoreType(@RequestBody ResourceStoreTypePo resourceResourceStoreTypeTypePo);

    @RequestMapping(value = "/updateResourceStoreType", method = RequestMethod.POST)
    public int updateResourceStoreType(@RequestBody  ResourceStoreTypePo resourceResourceStoreTypeTypePo);

    @RequestMapping(value = "/deleteResourceStoreType", method = RequestMethod.POST)
