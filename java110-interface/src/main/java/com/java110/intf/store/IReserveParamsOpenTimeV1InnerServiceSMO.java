...
import com.java110.po.reserve.ReserveParamsOpenTimePo;
...
@RequestMapping("/reserveParamsOpenTimeV1Api")
public interface IReserveParamsOpenTimeV1InnerServiceSMO {
    ...
    @RequestMapping(value = "/deleteReserveParamsOpenTime", method = RequestMethod.POST)
     ...
     *
     *
     * @param reserveParamsOpenTimeDto 数据对象分享
     * @return ReserveParamsOpenTimeDto 对象数据
     */
    @RequestMapping(value = "/queryReserveParamsOpenTimes", method = RequestMethod.POST)
    List<ReserveParamsOpenTimeDto> queryReserveParamsOpenTimes(@RequestBody ReserveParamsOpenTimeDto reserveParamsOpenTimeDto);
     ...
     * @return 小区下的小区楼记录数
     */
    @RequestMapping(value = "/queryReserveParamsOpenTimesCount", method = RequestMethod.POST)
    int queryReserveParamsOpenTimesCount(@RequestBody ReserveParamsOpenTimeDto reserveParamsOpenTimeDto);
}
