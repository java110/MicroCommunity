...
@RequestMapping("/storeShopV1Api")
public interface IStoreShopV1InnerServiceSMO {


    @RequestMapping(value = "/saveStoreShop", method = RequestMethod.POST)
    public int saveStoreShop(@RequestBody  StoreShopPo storeShopPo);

    @RequestMapping(value = "/updateStoreShop", method = RequestMethod.POST)
    public int updateStoreShop(@RequestBody  StoreShopPo storeShopPo);

    @RequestMapping(value = "/deleteStoreShop", method = RequestMethod.POST)
     ...
     * @return 小区下的小区楼记录数
     */
    @RequestMapping(value = "/queryStoreShopsCount", method = RequestMethod.POST)
    int queryStoreShopsCount(@RequestBody StoreShopDto storeShopDto);
}
