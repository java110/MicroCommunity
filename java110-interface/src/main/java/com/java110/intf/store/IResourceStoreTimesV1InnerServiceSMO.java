...
@RequestMapping("/resourceResourceStoreTimesTimesV1Api")
public interface IResourceStoreTimesV1InnerServiceSMO {
    ...
    @RequestMapping(value = "/deleteResourceStoreTimes", method = RequestMethod.POST)
     ...
     *
     *
     * @param resourceResourceStoreTimesTimesDto 数据对象分享
     * @return ResourceStoreTimesDto 对象数据
     */
    @RequestMapping(value = "/queryResourceStoreTimess", method = RequestMethod.POST)
    List<ResourceStoreTimesDto> queryResourceStoreTimess(@RequestBody ResourceStoreTimesDto resourceResourceStoreTimesTimesDto);
