...
@RequestMapping("/resourceResourceStoreUseV1Api")
public interface IResourceStoreUseRecordV1InnerServiceSMO {


    @RequestMapping(value = "/saveResourceStoreUseRecord", method = RequestMethod.POST)
    public int saveResourceStoreUseRecord(@RequestBody ResourceStoreUseRecordPo resourceResourceStoreUseRecordUseRecordPo);

    @RequestMapping(value = "/updateResourceStoreUseRecord", method = RequestMethod.POST)
    public int updateResourceStoreUseRecord(@RequestBody  ResourceStoreUseRecordPo resourceResourceStoreUseRecordUseRecordPo);

    @RequestMapping(value = "/deleteResourceStoreUseRecord", method = RequestMethod.POST)
