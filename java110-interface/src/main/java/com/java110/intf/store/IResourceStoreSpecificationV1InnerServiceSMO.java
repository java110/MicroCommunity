...
@RequestMapping("/resourceStoreSpecificationV1Api")
public interface IResourceStoreSpecificationV1InnerServiceSMO {


    @RequestMapping(value = "/saveResourceStoreSpecification", method = RequestMethod.POST)
    ...
    @RequestMapping(value = "/updateResourceStoreSpecification", method = RequestMethod.POST)
    ...
    @RequestMapping(value = "/deleteResourceStoreSpecification", method = RequestMethod.POST)
