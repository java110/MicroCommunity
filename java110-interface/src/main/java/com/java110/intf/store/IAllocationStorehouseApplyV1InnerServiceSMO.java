 ...
 * add by 吴学文 at 2022-03-28 15:58:52 mail: 928255095@qq.com
...
@RequestMapping("/allocationAllocationStorehouseApplyhouseApplyV1Api")
public interface IAllocationStorehouseApplyV1InnerServiceSMO {


    @RequestMapping(value = "/saveAllocationStorehouseApply", method = RequestMethod.POST)
    ...
    @RequestMapping(value = "/updateAllocationStorehouseApply", method = RequestMethod.POST)
    ...
    @RequestMapping(value = "/deleteAllocationStorehouseApply", method = RequestMethod.POST)
