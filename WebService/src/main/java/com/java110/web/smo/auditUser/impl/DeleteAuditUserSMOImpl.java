...
import com.java110.web.smo.auditUser.IDeleteAuditUserSMO;
 ...
 */
@Service("deleteAuditUserSMOImpl")
public class DeleteAuditUserSMOImpl extends AbstractComponentSMO implements IDeleteAuditUserSMO {
    ...
    @Override
    public ResponseEntity<String> deleteAuditUser(IPageData pd) {
