...
MySQL Backup
Database: TT
Backup Time: 2019-03-23 16:35:06
*/

SET FOREIGN_KEY_CHECKS=0;
DROP TABLE IF EXISTS `TT`.`a_agent`;
DROP TABLE IF EXISTS `TT`.`a_agent_attr`;
DROP TABLE IF EXISTS `TT`.`a_agent_cerdentials`;
DROP TABLE IF EXISTS `TT`.`a_agent_photo`;
DROP TABLE IF EXISTS `TT`.`a_agent_user`;
DROP TABLE IF EXISTS `TT`.`agent_user_rel`;
DROP TABLE IF EXISTS `TT`.`business_agent`;
DROP TABLE IF EXISTS `TT`.`business_agent_attr`;
DROP TABLE IF EXISTS `TT`.`business_agent_cerdentials`;
DROP TABLE IF EXISTS `TT`.`business_agent_photo`;
DROP TABLE IF EXISTS `TT`.`business_agent_user`;
DROP TABLE IF EXISTS `TT`.`business_community`;
DROP TABLE IF EXISTS `TT`.`business_community_attr`;
DROP TABLE IF EXISTS `TT`.`business_community_member`;
DROP TABLE IF EXISTS `TT`.`business_community_photo`;
DROP TABLE IF EXISTS `TT`.`business_member_store`;
DROP TABLE IF EXISTS `TT`.`business_property`;
DROP TABLE IF EXISTS `TT`.`business_property_attr`;
DROP TABLE IF EXISTS `TT`.`business_property_cerdentials`;
DROP TABLE IF EXISTS `TT`.`business_property_fee`;
DROP TABLE IF EXISTS `TT`.`business_property_house`;
DROP TABLE IF EXISTS `TT`.`business_property_house_attr`;
DROP TABLE IF EXISTS `TT`.`business_property_photo`;
DROP TABLE IF EXISTS `TT`.`business_property_user`;
DROP TABLE IF EXISTS `TT`.`business_shop`;
DROP TABLE IF EXISTS `TT`.`business_shop_attr`;
DROP TABLE IF EXISTS `TT`.`business_shop_attr_param`;
DROP TABLE IF EXISTS `TT`.`business_shop_catalog`;
DROP TABLE IF EXISTS `TT`.`business_shop_desc`;
DROP TABLE IF EXISTS `TT`.`business_shop_photo`;
DROP TABLE IF EXISTS `TT`.`business_shop_preferential`;
DROP TABLE IF EXISTS `TT`.`business_store`;
DROP TABLE IF EXISTS `TT`.`business_store_attr`;
DROP TABLE IF EXISTS `TT`.`business_store_cerdentials`;
DROP TABLE IF EXISTS `TT`.`business_store_photo`;
DROP TABLE IF EXISTS `TT`.`business_user`;
DROP TABLE IF EXISTS `TT`.`business_user_address`;
DROP TABLE IF EXISTS `TT`.`business_user_attr`;
DROP TABLE IF EXISTS `TT`.`business_user_credentials`;
DROP TABLE IF EXISTS `TT`.`business_user_tag`;
DROP TABLE IF EXISTS `TT`.`c_app`;
DROP TABLE IF EXISTS `TT`.`c_business`;
DROP TABLE IF EXISTS `TT`.`c_business_attrs`;
DROP TABLE IF EXISTS `TT`.`c_business_type`;
DROP TABLE IF EXISTS `TT`.`c_cache_2_user`;
DROP TABLE IF EXISTS `TT`.`c_cache`;
DROP TABLE IF EXISTS `TT`.`c_comment`;
DROP TABLE IF EXISTS `TT`.`c_comment_score`;
DROP TABLE IF EXISTS `TT`.`c_mapping`;
DROP TABLE IF EXISTS `TT`.`c_order_type`;
DROP TABLE IF EXISTS `TT`.`c_orders`;
DROP TABLE IF EXISTS `TT`.`c_orders_attrs`;
DROP TABLE IF EXISTS `TT`.`c_route`;
DROP TABLE IF EXISTS `TT`.`c_service`;
DROP TABLE IF EXISTS `TT`.`c_service_business`;
DROP TABLE IF EXISTS `TT`.`c_service_sql`;
DROP TABLE IF EXISTS `TT`.`c_status`;
DROP TABLE IF EXISTS `TT`.`c_sub_comment`;
DROP TABLE IF EXISTS `TT`.`c_sub_comment_attr`;
DROP TABLE IF EXISTS `TT`.`c_sub_comment_photo`;
DROP TABLE IF EXISTS `TT`.`c_template`;
DROP TABLE IF EXISTS `TT`.`c_template_col`;
DROP TABLE IF EXISTS `TT`.`community_member_type`;
DROP TABLE IF EXISTS `TT`.`credentials`;
DROP TABLE IF EXISTS `TT`.`l_transaction_log`;
DROP TABLE IF EXISTS `TT`.`l_transaction_log_message`;
DROP TABLE IF EXISTS `TT`.`m_menu_2_user`;
DROP TABLE IF EXISTS `TT`.`m_menu`;
DROP TABLE IF EXISTS `TT`.`m_menu_ctg`;
DROP TABLE IF EXISTS `TT`.`p_property`;
DROP TABLE IF EXISTS `TT`.`p_property_attr`;
DROP TABLE IF EXISTS `TT`.`p_property_cerdentials`;
DROP TABLE IF EXISTS `TT`.`p_property_fee`;
DROP TABLE IF EXISTS `TT`.`p_property_house`;
DROP TABLE IF EXISTS `TT`.`p_property_house_attr`;
DROP TABLE IF EXISTS `TT`.`p_property_photo`;
DROP TABLE IF EXISTS `TT`.`p_property_user`;
DROP TABLE IF EXISTS `TT`.`property_fee_time`;
DROP TABLE IF EXISTS `TT`.`property_fee_type`;
DROP TABLE IF EXISTS `TT`.`property_user_rel`;
DROP TABLE IF EXISTS `TT`.`s_buy_shop`;
DROP TABLE IF EXISTS `TT`.`s_buy_shop_attr`;
DROP TABLE IF EXISTS `TT`.`s_community`;
DROP TABLE IF EXISTS `TT`.`s_community_attr`;
DROP TABLE IF EXISTS `TT`.`s_community_member`;
DROP TABLE IF EXISTS `TT`.`s_community_photo`;
DROP TABLE IF EXISTS `TT`.`s_member_store`;
DROP TABLE IF EXISTS `TT`.`s_shop`;
DROP TABLE IF EXISTS `TT`.`s_shop_attr`;
DROP TABLE IF EXISTS `TT`.`s_shop_attr_param`;
DROP TABLE IF EXISTS `TT`.`s_shop_catalog`;
DROP TABLE IF EXISTS `TT`.`s_shop_desc`;
DROP TABLE IF EXISTS `TT`.`s_shop_photo`;
DROP TABLE IF EXISTS `TT`.`s_shop_preferential`;
DROP TABLE IF EXISTS `TT`.`s_store`;
DROP TABLE IF EXISTS `TT`.`s_store_attr`;
DROP TABLE IF EXISTS `TT`.`s_store_cerdentials`;
DROP TABLE IF EXISTS `TT`.`s_store_fee`;
DROP TABLE IF EXISTS `TT`.`s_store_house`;
DROP TABLE IF EXISTS `TT`.`s_store_house_attr`;
DROP TABLE IF EXISTS `TT`.`s_store_photo`;
DROP TABLE IF EXISTS `TT`.`spec`;
DROP TABLE IF EXISTS `TT`.`store_fee_time`;
DROP TABLE IF EXISTS `TT`.`store_fee_type`;
DROP TABLE IF EXISTS `TT`.`store_type`;
DROP TABLE IF EXISTS `TT`.`tag`;
DROP TABLE IF EXISTS `TT`.`u_location`;
DROP TABLE IF EXISTS `TT`.`u_user`;
DROP TABLE IF EXISTS `TT`.`u_user_address`;
DROP TABLE IF EXISTS `TT`.`u_user_attr`;
DROP TABLE IF EXISTS `TT`.`u_user_credentials`;
DROP TABLE IF EXISTS `TT`.`u_user_tag`;
DROP TABLE IF EXISTS `TT`.`user_level`;
