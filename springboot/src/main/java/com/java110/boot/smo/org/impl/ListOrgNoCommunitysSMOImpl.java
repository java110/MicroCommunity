package com.java110.boot.smo.org.impl;

import com.alibaba.fastjson.JSONObject;
import com.java110.boot.smo.DefaultAbstractComponentSMO;
import com.java110.boot.smo.org.IListOrgNoCommunitysSMO;
...
public class ListOrgNoCommunitysSMOImpl extends DefaultAbstractComponentSMO implements IListOrgNoCommunitysSMO {
    ...
    protected ResponseEntity<String> doBusinessProcess(IPageData pd, JSONObject paramIn) {
        ...
        String apiUrl = "org.listOrgNoCommunitys" + mapToUrlParam(paramIn);
