 ...
 */
@RestController
public class ResourceStoreV1InnerServiceSMOImpl extends BaseServiceSMO implements IResourceStoreV1InnerServiceSMO {

    @Autowired
    private IResourceStoreV1ServiceDao resourceResourceStoreV1ServiceDaoImpl;


    @Override
    public int saveResourceStore(@RequestBody ResourceStorePo resourceResourceStorePo) {
        int saveFlag = resourceResourceStoreV1ServiceDaoImpl.saveResourceStoreInfo(BeanConvertUtil.beanCovertMap(resourceResourceStorePo));
        return saveFlag;
    }
    ...
    public List<ResourceStoreDto> queryResourceStores(@RequestBody  ResourceStoreDto resourceResourceStoreDto) {
        ...
        List<ResourceStoreDto> resourceResourceStores = BeanConvertUtil.covertBeanList(resourceResourceStoreV1ServiceDaoImpl.getResourceStoreInfo(BeanConvertUtil.beanCovertMap(resourceResourceStoreDto)), ResourceStoreDto.class);
