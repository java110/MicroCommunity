 ...
 */
@RestController
public class StoreAttrV1InnerServiceSMOImpl extends BaseServiceSMO implements IStoreAttrV1InnerServiceSMO {

    @Autowired
    private IStoreAttrV1ServiceDao storeAttrV1ServiceDaoImpl;
    ...
    public List<StoreAttrDto> queryStoreAttrs(@RequestBody StoreAttrDto storeAttrDto) {
        ...
        List<StoreAttrDto> storeAttrs = BeanConvertUtil.covertBeanList(storeAttrV1ServiceDaoImpl.getStoreAttrInfo(BeanConvertUtil.beanCovertMap(storeAttrDto)), StoreAttrDto.class);
