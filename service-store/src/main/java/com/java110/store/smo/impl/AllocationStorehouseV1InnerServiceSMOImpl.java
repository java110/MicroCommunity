 ...
 */
@RestController
public class AllocationStorehouseV1InnerServiceSMOImpl extends BaseServiceSMO implements IAllocationStorehouseV1InnerServiceSMO {

    @Autowired
    private IAllocationStorehouseV1ServiceDao allocationAllocationStorehousehouseV1ServiceDaoImpl;


    @Override
    public int saveAllocationStorehouse(@RequestBody AllocationStorehousePo allocationAllocationStorehousehousePo) {
        int saveFlag = allocationAllocationStorehousehouseV1ServiceDaoImpl.saveAllocationStorehouseInfo(BeanConvertUtil.beanCovertMap(allocationAllocationStorehousehousePo));
        return saveFlag;
    }

    @Override
    public int updateAllocationStorehouse(@RequestBody AllocationStorehousePo allocationAllocationStorehousehousePo) {
        int saveFlag = allocationAllocationStorehousehouseV1ServiceDaoImpl.updateAllocationStorehouseInfo(BeanConvertUtil.beanCovertMap(allocationAllocationStorehousehousePo));
        return saveFlag;
    }

    @Override
    public int deleteAllocationStorehouse(@RequestBody AllocationStorehousePo allocationAllocationStorehousehousePo) {
        allocationAllocationStorehousehousePo.setStatusCd("1");
        int saveFlag = allocationAllocationStorehousehouseV1ServiceDaoImpl.updateAllocationStorehouseInfo(BeanConvertUtil.beanCovertMap(allocationAllocationStorehousehousePo));
        return saveFlag;
    }
    ...
    public List<AllocationStorehouseDto> queryAllocationStorehouses(@RequestBody AllocationStorehouseDto allocationAllocationStorehousehouseDto) {
        ...
        List<AllocationStorehouseDto> allocationAllocationStorehousehouses = BeanConvertUtil.covertBeanList(allocationAllocationStorehousehouseV1ServiceDaoImpl.getAllocationStorehouseInfo(BeanConvertUtil.beanCovertMap(allocationAllocationStorehousehouseDto)), AllocationStorehouseDto.class);
    ...
    public int queryAllocationStorehousesCount(@RequestBody AllocationStorehouseDto allocationAllocationStorehousehouseDto) {
        return allocationAllocationStorehousehouseV1ServiceDaoImpl.queryAllocationStorehousesCount(BeanConvertUtil.beanCovertMap(allocationAllocationStorehousehouseDto));
    }
