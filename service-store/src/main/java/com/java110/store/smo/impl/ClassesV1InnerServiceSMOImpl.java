 ...
 */
@RestController
public class ClassesV1InnerServiceSMOImpl extends BaseServiceSMO implements IClassesV1InnerServiceSMO {
    ...
    public List<ClassesDto> queryClassess(@RequestBody ClassesDto classesDto) {
        ...
        int page = classesDto.getPage();

        if (page != PageDto.DEFAULT_PAGE) {
            classesDto.setPage((page - 1) * classesDto.getRow());
        }
