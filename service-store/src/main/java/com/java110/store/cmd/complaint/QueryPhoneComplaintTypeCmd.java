 ...
 */
@Java110Cmd(serviceCode = "complaint.queryPhoneComplaintType")
public class QueryPhoneComplaintTypeCmd extends Cmd {

    private static Logger logger = LoggerFactory.getLogger(QueryPhoneComplaintTypeCmd.class);
    @Autowired
