 ...
 */
@Java110Cmd(serviceCode = "complaint.listPhoneComplaintEvent")
public class ListPhoneComplaintEventCmd extends Cmd {

  private static Logger logger = LoggerFactory.getLogger(ListPhoneComplaintEventCmd.class);
    @Autowired
