...
/**
 * 类表述：更新
 * 服务编码：storeShopCommunity.updateStoreShopCommunity
 * 请求路劲：/app/storeShopCommunity.UpdateStoreShopCommunity
 ...
 */
@Java110Cmd(serviceCode = "storeShopCommunity.updateStoreShopCommunity")
public class UpdateStoreShopCommunityCmd extends Cmd {

  private static Logger logger = LoggerFactory.getLogger(UpdateStoreShopCommunityCmd.class);
...
Assert.hasKeyAndValue(reqJson, "shopId", "shopId不能为空");
    ...
    public void doCmd(CmdEvent event, ICmdDataFlowContext cmdDataFlowContext, JSONObject reqJson) throws CmdException {
       ...
       StoreShopCommunityPo storeShopCommunityPo = BeanConvertUtil.covertBean(reqJson, StoreShopCommunityPo.class);
        int flag = storeShopCommunityV1InnerServiceSMOImpl.updateStoreShopCommunity(storeShopCommunityPo);
