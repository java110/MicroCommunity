...
/**
 * 类表述：更新
 * 服务编码：scheduleClassesStaff.updateScheduleClassesStaff
 * 请求路劲：/app/scheduleClassesStaff.UpdateScheduleClassesStaff
 ...
 */
@Java110Cmd(serviceCode = "scheduleClasses.updateScheduleClassesStaff")
public class UpdateScheduleClassesStaffCmd extends Cmd {

  private static Logger logger = LoggerFactory.getLogger(UpdateScheduleClassesStaffCmd.class);
...
Assert.hasKeyAndValue(reqJson, "scheduleId", "scheduleId不能为空");
    ...
    public void doCmd(CmdEvent event, ICmdDataFlowContext cmdDataFlowContext, JSONObject reqJson) throws CmdException {
       ...
       ScheduleClassesStaffPo scheduleClassesStaffPo = BeanConvertUtil.covertBean(reqJson, ScheduleClassesStaffPo.class);
        int flag = scheduleClassesStaffV1InnerServiceSMOImpl.updateScheduleClassesStaff(scheduleClassesStaffPo);
