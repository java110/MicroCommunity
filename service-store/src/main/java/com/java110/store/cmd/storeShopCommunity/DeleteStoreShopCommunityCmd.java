...
/**
 * 类表述：删除
 * 服务编码：storeShopCommunity.deleteStoreShopCommunity
 * 请求路劲：/app/storeShopCommunity.DeleteStoreShopCommunity
 ...
 */
@Java110Cmd(serviceCode = "storeShopCommunity.deleteStoreShopCommunity")
public class DeleteStoreShopCommunityCmd extends Cmd {
  private static Logger logger = LoggerFactory.getLogger(DeleteStoreShopCommunityCmd.class);
...
Assert.hasKeyAndValue(reqJson, "shopId", "shopId不能为空");
    ...
    public void doCmd(CmdEvent event, ICmdDataFlowContext cmdDataFlowContext, JSONObject reqJson) throws CmdException {
       ...
       StoreShopCommunityPo storeShopCommunityPo = BeanConvertUtil.covertBean(reqJson, StoreShopCommunityPo.class);
        int flag = storeShopCommunityV1InnerServiceSMOImpl.deleteStoreShopCommunity(storeShopCommunityPo);
