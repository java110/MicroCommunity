 ...
 */
@Java110Cmd(serviceCode = "complaintAppraise.listComplaintAppraise")
public class ListComplaintAppraiseCmd extends Cmd {

  private static Logger logger = LoggerFactory.getLogger(ListComplaintAppraiseCmd.class);
    @Autowired
