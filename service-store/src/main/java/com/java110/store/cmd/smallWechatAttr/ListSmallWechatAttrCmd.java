...
/**
 * 类表述：查询
 * 服务编码：smallWechatAttr.listSmallWechatAttr
 * 请求路劲：/app/smallWechatAttr.ListSmallWechatAttr
 ...
 */
@Java110Cmd(serviceCode = "smallWechatAttr.listSmallWechatAttr")
public class ListSmallWechatAttrCmd extends AbstractServiceCmdListener {

  private static Logger logger = LoggerFactory.getLogger(ListSmallWechatAttrCmd.class);
    @Autowired
    ...
    public void doCmd(CmdEvent event, ICmdDataFlowContext cmdDataFlowContext, JSONObject reqJson) throws CmdException {
           ...
           int count = smallWechatAttrV1InnerServiceSMOImpl.querySmallWechatAttrsCount(smallWechatAttrDto);

           List<SmallWechatAttrDto> smallWechatAttrDtos = null;

           if (count > 0) {
               smallWechatAttrDtos = smallWechatAttrV1InnerServiceSMOImpl.querySmallWechatAttrs(smallWechatAttrDto);
           } else {
