...
/**
 * 类表述：删除
 * 服务编码：assetInventory.deleteAssetInventory
 * 请求路劲：/app/assetInventory.DeleteAssetInventory
 ...
 */
@Java110Cmd(serviceCode = "assetInventory.deleteAssetInventory")
public class DeleteAssetInventoryCmd extends Cmd {
    private static Logger logger = LoggerFactory.getLogger(DeleteAssetInventoryCmd.class);
    ...
    public void doCmd(CmdEvent event, ICmdDataFlowContext cmdDataFlowContext, JSONObject reqJson) throws CmdException {
        ...
        int flag = assetInventoryV1InnerServiceSMOImpl.deleteAssetInventory(assetInventoryPo);
