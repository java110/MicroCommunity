 ...
 */
@Java110Cmd(serviceCode = "classes.updateClasses")
public class UpdateClassesCmd extends Cmd {

  private static Logger logger = LoggerFactory.getLogger(UpdateClassesCmd.class);
