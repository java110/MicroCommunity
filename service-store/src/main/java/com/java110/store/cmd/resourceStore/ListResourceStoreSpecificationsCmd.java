...
/**
 * 类表述：查询
 * 服务编码：resourceStoreSpecification.listResourceStoreSpecification
 * 请求路劲：/app/resourceStoreSpecification.ListResourceStoreSpecification
 ...
 */
@Java110Cmd(serviceCode = "resourceStore.listResourceStoreSpecifications")
public class ListResourceStoreSpecificationsCmd extends Cmd {

  private static Logger logger = LoggerFactory.getLogger(ListResourceStoreSpecificationsCmd.class);
    @Autowired
