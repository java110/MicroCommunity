...
/**
 * 类表述：更新
 * 服务编码：reserveParams.updateReserveParams
 * 请求路劲：/app/reserveParams.UpdateReserveParams
 ...
 */
@Java110Cmd(serviceCode = "reserve.updateReserveParams")
public class UpdateReserveParamsCmd extends Cmd {

    private static Logger logger = LoggerFactory.getLogger(UpdateReserveParamsCmd.class);
    ...
    public void doCmd(CmdEvent event, ICmdDataFlowContext cmdDataFlowContext, JSONObject reqJson) throws CmdException {
        ...
        int flag = reserveParamsV1InnerServiceSMOImpl.updateReserveParams(reserveParamsPo);
