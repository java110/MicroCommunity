 ...
 */
@Java110Cmd(serviceCode = "complaintType.listAdminComplaintType")
public class ListAdminComplaintTypeCmd extends Cmd {

    private static Logger logger = LoggerFactory.getLogger(ListAdminComplaintTypeCmd.class);
    @Autowired
