...
public class SupplierKeyV1InnerServiceSMOImpl extends BaseServiceSMO implements ISupplierKeyV1InnerServiceSMO {
    ...
    @Override
    public List<SupplierKeyDto> querySupplierKeys(@RequestBody  SupplierKeyDto supplierKeyDto) {

        //校验是否传了 分页信息

        int page = supplierKeyDto.getPage();
    ...
    @Override
    public int querySupplierKeysCount(@RequestBody SupplierKeyDto supplierKeyDto) {
        return supplierKeyV1ServiceDaoImpl.querySupplierKeysCount(BeanConvertUtil.beanCovertMap(supplierKeyDto));    }
