...
public class DeleteOrgListener extends AbstractServiceApiListener {
    @Override
    ...
    protected void doSoService(ServiceDataFlowEvent event, DataFlowContext context, JSONObject reqJson) {
        ...
        //添加单元信息
        businesses.add(deleteOrg(reqJson, context));
     ...
     * @return 订单服务能够接受的报文
     */
    private JSONObject deleteOrg(JSONObject paramInJson, DataFlowContext dataFlowContext) {
