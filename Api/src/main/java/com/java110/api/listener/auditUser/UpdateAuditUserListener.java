 ...
 */
@Java110Listener("updateAuditUserListener")
public class UpdateAuditUserListener extends AbstractServiceApiListener {
    @Override
...
Assert.hasKeyAndValue(reqJson, "objCode", "必填，请填写流程对象");
    ...
    protected void doSoService(ServiceDataFlowEvent event, DataFlowContext context, JSONObject reqJson) {
        ...
        //添加单元信息
        businesses.add(updateAuditUser(reqJson, context));
    ...
    public String getServiceCode() {
        return ServiceCodeAuditUserConstant.UPDATE_AUDITUSER;
    }
     ...
     * @return 订单服务能够接受的报文
     */
    private JSONObject updateAuditUser(JSONObject paramInJson, DataFlowContext dataFlowContext) {


        JSONObject business = JSONObject.parseObject("{\"datas\":{}}");
        business.put(CommonConstant.HTTP_BUSINESS_TYPE_CD, BusinessTypeConstant.BUSINESS_TYPE_UPDATE_AUDIT_USER);
