...
public class En extends DefaultLanguage{
    ...
    static {
        ...
        menus.put("房源信息","Listing ");
        menus.put("出租审核","Receipt template");
        menus.put("租赁预约","Receipt template");
        menus.put("出租历史","Receipt template");
        menus.put("智慧运营","Receipt template");
        menus.put("旧货甩卖","Receipt template");
        menus.put("发布需求","Receipt template");
        menus.put("制作优惠券","Receipt template");
        menus.put("购买记录","Receipt template");
        menus.put("商家店铺","Receipt template");
        menus.put("商城菜单","Receipt template");
        menus.put("开店审核","Receipt template");
        menus.put("店铺信息","Receipt template");
        menus.put("入驻审核","Receipt template");
        menus.put("小区店铺","Receipt template");
        menus.put("专区目录","Receipt template");
        menus.put("专区商品","Receipt template");
        menus.put("店铺类型","Receipt template");
        menus.put("上架服务","Receipt template");
        menus.put("上架商品","Receipt template");
        menus.put("店铺变更","Receipt template");
        menus.put("财务管理","Receipt template");
        menus.put("提现审核","Receipt template");
        menus.put("提现付款","Receipt template");
        menus.put("提现记录","Receipt template");
        menus.put("设置保证金","Receipt template");
        menus.put("保证金明细","Receipt template");
        menus.put("商户管理","Receipt template");
        menus.put("商户信息","Receipt template");
        menus.put("商户管理员","Receipt template");
        menus.put("营销中心","Receipt template");
        menus.put("发布广告","Receipt template");
        menus.put("便民菜单维护","Receipt template");
        menus.put("订单中心","Receipt template");
        menus.put("受理单","Receipt template");
        menus.put("登录日志","Receipt template");
        menus.put("商城订单","Receipt template");
        menus.put("退货订单","Receipt template");
        menus.put("系统管理","Receipt template");
        menus.put("修改密码","Receipt template");
