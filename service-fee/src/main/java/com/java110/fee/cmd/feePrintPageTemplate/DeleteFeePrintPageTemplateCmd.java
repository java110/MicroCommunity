...
/**
 * 类表述：删除
 * 服务编码：feePrintPageTemplate.deleteFeePrintPageTemplate
 * 请求路劲：/app/feePrintPageTemplate.DeleteFeePrintPageTemplate
 ...
 */
@Java110Cmd(serviceCode = "feePrintPageTemplate.deleteFeePrintPageTemplate")
public class DeleteFeePrintPageTemplateCmd extends AbstractServiceCmdListener {
    private static Logger logger = LoggerFactory.getLogger(DeleteFeePrintPageTemplateCmd.class);
    ...
    public void doCmd(CmdEvent event, ICmdDataFlowContext cmdDataFlowContext, JSONObject reqJson) throws CmdException {
        ...
        int flag = feePrintPageTemplateV1InnerServiceSMOImpl.deleteFeePrintPageTemplate(feePrintPageTemplatePo);
