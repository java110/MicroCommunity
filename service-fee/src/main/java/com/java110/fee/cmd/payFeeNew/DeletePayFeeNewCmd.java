...
/**
 * 类表述：删除
 * 服务编码：payFeeNew.deletePayFeeNew
 * 请求路劲：/app/payFeeNew.DeletePayFeeNew
 ...
 */
@Java110Cmd(serviceCode = "payFeeNew.deletePayFeeNew")
public class DeletePayFeeNewCmd extends AbstractServiceCmdListener {
  private static Logger logger = LoggerFactory.getLogger(DeletePayFeeNewCmd.class);
...
Assert.hasKeyAndValue(reqJson, "communityId", "communityId不能为空");
    ...
    public void doCmd(CmdEvent event, ICmdDataFlowContext cmdDataFlowContext, JSONObject reqJson) throws CmdException {
       ...
       PayFeePo payFeeNewPo = BeanConvertUtil.covertBean(reqJson, PayFeePo.class);
        int flag = payFeeNewV1InnerServiceSMOImpl.deletePayFeeNew(payFeeNewPo);
