...
/**
 * 类表述：更新
 * 服务编码：payFeeRule.updatePayFeeRule
 * 请求路劲：/app/payFeeRule.UpdatePayFeeRule
 ...
 */
@Java110Cmd(serviceCode = "payFeeRule.updatePayFeeRule")
public class UpdatePayFeeRuleCmd extends Cmd {

    private static Logger logger = LoggerFactory.getLogger(UpdatePayFeeRuleCmd.class);
    ...
    public void doCmd(CmdEvent event, ICmdDataFlowContext cmdDataFlowContext, JSONObject reqJson) throws CmdException {
        ...
        int flag = payFeeRuleV1InnerServiceSMOImpl.updatePayFeeRule(payFeeRulePo);
