...
/**
 * 类表述：更新
 * 服务编码：payFeeQrcode.updatePayFeeQrcode
 * 请求路劲：/app/payFeeQrcode.UpdatePayFeeQrcode
 ...
 */
@Java110Cmd(serviceCode = "payFeeQrcode.updatePayFeeQrcode")
public class UpdatePayFeeQrcodeCmd extends Cmd {

    private static Logger logger = LoggerFactory.getLogger(UpdatePayFeeQrcodeCmd.class);
    ...
    public void doCmd(CmdEvent event, ICmdDataFlowContext cmdDataFlowContext, JSONObject reqJson) throws CmdException {
        ...
        int flag = payFeeQrcodeV1InnerServiceSMOImpl.updatePayFeeQrcode(payFeeQrcodePo);
