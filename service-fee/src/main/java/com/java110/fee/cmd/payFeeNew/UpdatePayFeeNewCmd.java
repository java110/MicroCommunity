...
/**
 * 类表述：更新
 * 服务编码：payFeeNew.updatePayFeeNew
 * 请求路劲：/app/payFeeNew.UpdatePayFeeNew
 ...
 */
@Java110Cmd(serviceCode = "payFeeNew.updatePayFeeNew")
public class UpdatePayFeeNewCmd extends AbstractServiceCmdListener {

  private static Logger logger = LoggerFactory.getLogger(UpdatePayFeeNewCmd.class);
...
Assert.hasKeyAndValue(reqJson, "communityId", "communityId不能为空");
    ...
    public void doCmd(CmdEvent event, ICmdDataFlowContext cmdDataFlowContext, JSONObject reqJson) throws CmdException {
       ...
       PayFeePo payFeeNewPo = BeanConvertUtil.covertBean(reqJson, PayFeePo.class);
        int flag = payFeeNewV1InnerServiceSMOImpl.updatePayFeeNew(payFeeNewPo);
