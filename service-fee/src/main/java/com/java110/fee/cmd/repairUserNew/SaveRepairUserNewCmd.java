...
/**
 * 类表述：保存
 * 服务编码：repairUserNew.saveRepairUserNew
 * 请求路劲：/app/repairUserNew.SaveRepairUserNew
 ...
 */
@Java110Cmd(serviceCode = "repairUserNew.saveRepairUserNew")
public class SaveRepairUserNewCmd extends AbstractServiceCmdListener {

    private static Logger logger = LoggerFactory.getLogger(SaveRepairUserNewCmd.class);
