...
/**
 * 初始化 DataFlowContext 对象异常
 * Created by wuxw on 2018/4/14.
 */
public class InitDataFlowContextException extends RuntimeException {


    private Result result;
    private Throwable cause = this;

    public InitDataFlowContextException(){}
     ...
     * @param cause  异常堆栈
     */
    public InitDataFlowContextException(Result result, Throwable cause) {
     ...
     * @param msg  错误消息
     */
    public InitDataFlowContextException(int code, String msg) {
        super(msg);
        this.result = new Result(code, msg);
    }

    public InitDataFlowContextException(String code, String msg) {
        super(msg);
        this.result = new Result(code, msg);
    }
     ...
     */
    public InitDataFlowContextException(Result result, String detail) {
     ...
     * @param cause  异常堆栈
     */
    public InitDataFlowContextException(Result result, String detail, Throwable cause) {
     ...
     * @param cause 异常堆栈
     */
    public InitDataFlowContextException(int code, String msg, Throwable cause) {
        super(msg, cause);
     ...
     * @param cause	异常堆栈
     */
    public InitDataFlowContextException(int code, Throwable cause) {
        super(cause);
        String msg = "";
