...
public class InterceptorException extends RuntimeException {
     ...
     * @param cause  异常堆栈
     */
    public InterceptorException(Result result, Throwable cause) {
     ...
     */
    public InterceptorException(Result result, String detail) {
     ...
     * @param cause  异常堆栈
     */
    public InterceptorException(Result result, String detail, Throwable cause) {
     ...
     * @param cause 异常堆栈
     */
    public InterceptorException(int code, String msg, Throwable cause) {
        super(msg, cause);
     ...
     * @param cause	异常堆栈
     */
    public InterceptorException(int code, Throwable cause) {
        super(cause);
        String msg = "";
