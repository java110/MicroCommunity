...
/**
 * 类表述：删除
 * 服务编码：workEvent.deleteWorkEvent
 * 请求路劲：/app/workEvent.DeleteWorkEvent
 ...
 */
@Java110Cmd(serviceCode = "workEvent.deleteWorkEvent")
public class DeleteWorkEventCmd extends Cmd {
    private static Logger logger = LoggerFactory.getLogger(DeleteWorkEventCmd.class);
    ...
    public void doCmd(CmdEvent event, ICmdDataFlowContext cmdDataFlowContext, JSONObject reqJson) throws CmdException {
        ...
        int flag = workEventV1InnerServiceSMOImpl.deleteWorkEvent(workEventPo);
