...
/**
 * 类表述：更新
 * 服务编码：workEvent.updateWorkEvent
 * 请求路劲：/app/workEvent.UpdateWorkEvent
 ...
 */
@Java110Cmd(serviceCode = "workEvent.updateWorkEvent")
public class UpdateWorkEventCmd extends Cmd {

    private static Logger logger = LoggerFactory.getLogger(UpdateWorkEventCmd.class);
    ...
    public void doCmd(CmdEvent event, ICmdDataFlowContext cmdDataFlowContext, JSONObject reqJson) throws CmdException {
        ...
        int flag = workEventV1InnerServiceSMOImpl.updateWorkEvent(workEventPo);
