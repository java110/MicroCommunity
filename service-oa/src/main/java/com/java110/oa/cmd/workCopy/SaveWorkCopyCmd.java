...
/**
 * 类表述：保存
 * 服务编码：workCopy.saveWorkCopy
 * 请求路劲：/app/workCopy.SaveWorkCopy
 ...
 */
@Java110Cmd(serviceCode = "workCopy.saveWorkCopy")
public class SaveWorkCopyCmd extends Cmd {

    private static Logger logger = LoggerFactory.getLogger(SaveWorkCopyCmd.class);
    ...
    public void doCmd(CmdEvent event, ICmdDataFlowContext cmdDataFlowContext, JSONObject reqJson) throws CmdException {
        ...
        int flag = workCopyV1InnerServiceSMOImpl.saveWorkCopy(workCopyPo);
