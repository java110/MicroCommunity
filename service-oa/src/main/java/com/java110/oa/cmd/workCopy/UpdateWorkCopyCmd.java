 ...
 */
package com.java110.oa.cmd.workCopy;
...
/**
 * 类表述：更新
 * 服务编码：workCopy.updateWorkCopy
 * 请求路劲：/app/workCopy.UpdateWorkCopy
 ...
 */
@Java110Cmd(serviceCode = "workCopy.updateWorkCopy")
public class UpdateWorkCopyCmd extends Cmd {

    private static Logger logger = LoggerFactory.getLogger(UpdateWorkCopyCmd.class);
    ...
    public void doCmd(CmdEvent event, ICmdDataFlowContext cmdDataFlowContext, JSONObject reqJson) throws CmdException {
        ...
        int flag = workCopyV1InnerServiceSMOImpl.updateWorkCopy(workCopyPo);
