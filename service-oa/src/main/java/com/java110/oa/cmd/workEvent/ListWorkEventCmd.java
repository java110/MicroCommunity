 ...
 */
@Java110Cmd(serviceCode = "workEvent.listWorkEvent")
public class ListWorkEventCmd extends Cmd {

  private static Logger logger = LoggerFactory.getLogger(ListWorkEventCmd.class);
    @Autowired
