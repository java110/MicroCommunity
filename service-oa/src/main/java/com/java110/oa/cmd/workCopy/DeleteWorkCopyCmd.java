...
/**
 * 类表述：删除
 * 服务编码：workCopy.deleteWorkCopy
 * 请求路劲：/app/workCopy.DeleteWorkCopy
 ...
 */
@Java110Cmd(serviceCode = "workCopy.deleteWorkCopy")
public class DeleteWorkCopyCmd extends Cmd {
    private static Logger logger = LoggerFactory.getLogger(DeleteWorkCopyCmd.class);
