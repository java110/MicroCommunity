...
/**
 * 类表述：保存
 * 服务编码：workTask.saveWorkTask
 * 请求路劲：/app/workTask.SaveWorkTask
 ...
 */
@Java110Cmd(serviceCode = "workTask.saveWorkTask")
public class SaveWorkTaskCmd extends Cmd {

    private static Logger logger = LoggerFactory.getLogger(SaveWorkTaskCmd.class);
    ...
    public void doCmd(CmdEvent event, ICmdDataFlowContext cmdDataFlowContext, JSONObject reqJson) throws CmdException {
        ...
        workTaskPo.setTaskId(GenerateCodeFactory.getGeneratorId(CODE_PREFIX_ID));
