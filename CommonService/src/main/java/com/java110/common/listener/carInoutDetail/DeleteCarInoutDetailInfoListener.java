...
public class DeleteCarInoutDetailInfoListener extends AbstractCarInoutDetailBusinessServiceDataFlowListener {
    ...
    protected void doSaveBusiness(DataFlowContext dataFlowContext, Business business) {
        ...
        if (data.containsKey(BusinessTypeConstant.BUSINESS_TYPE_DELETE_CAR_INOUT_DETAIL)) {
            Object _obj = data.get(BusinessTypeConstant.BUSINESS_TYPE_DELETE_CAR_INOUT_DETAIL);
