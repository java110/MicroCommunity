...
public class UpdateJunkRequirementInfoListener extends AbstractJunkRequirementBusinessServiceDataFlowListener {
    ...
    protected void doSaveBusiness(DataFlowContext dataFlowContext, Business business) {
        ...
        if (data.containsKey(BusinessTypeConstant.BUSINESS_TYPE_UPDATE_JUNK_REQUIREMENT)) {
            Object _obj = data.get(BusinessTypeConstant.BUSINESS_TYPE_UPDATE_JUNK_REQUIREMENT);
