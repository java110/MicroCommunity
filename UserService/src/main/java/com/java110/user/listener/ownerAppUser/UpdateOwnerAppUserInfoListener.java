...
public class UpdateOwnerAppUserInfoListener extends AbstractOwnerAppUserBusinessServiceDataFlowListener {
    ...
    protected void doSaveBusiness(DataFlowContext dataFlowContext, Business business) {
        ...
        if (data.containsKey(BusinessTypeConstant.BUSINESS_TYPE_UPDATE_OWNER_APP_USER)) {
            Object _obj = data.get(BusinessTypeConstant.BUSINESS_TYPE_UPDATE_OWNER_APP_USER);
