...
public class DeleteOrgCommunityInfoListener extends AbstractOrgCommunityBusinessServiceDataFlowListener {
    ...
    protected void doSaveBusiness(DataFlowContext dataFlowContext, Business business) {
        ...
        if (data.containsKey(BusinessTypeConstant.BUSINESS_TYPE_DELETE_ORG_COMMUNITY)) {
            Object _obj = data.get(BusinessTypeConstant.BUSINESS_TYPE_DELETE_ORG_COMMUNITY);
