...
public class RemoveUserInfoListener extends AbstractUserBusinessServiceDataFlowListener {
    ...
    protected void doSaveBusiness(DataFlowContext dataFlowContext, Business business) {
        ...
        Assert.jsonObjectHaveKey(data, BusinessTypeConstant.BUSINESS_TYPE_REMOVE_USER_INFO, "datas 节点下没有包含 businessUser 节点");

        JSONObject businessUser = data.getJSONObject(BusinessTypeConstant.BUSINESS_TYPE_REMOVE_USER_INFO);
