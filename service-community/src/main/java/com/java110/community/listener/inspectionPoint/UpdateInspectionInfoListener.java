 ...
 */
@Java110Listener("updateInspectionInfoListener")
@Transactional
public class UpdateInspectionInfoListener extends AbstractInspectionBusinessServiceDataFlowListener {

    private static Logger logger = LoggerFactory.getLogger(UpdateInspectionInfoListener.class);
    @Autowired
    ...
    public String getBusinessTypeCd() {
        return BusinessTypeConstant.BUSINESS_TYPE_UPDATE_INSPECTION;
    }
     ...
     */
    private void doBusinessInspection(AppBusiness business, JSONObject businessInspection) {
