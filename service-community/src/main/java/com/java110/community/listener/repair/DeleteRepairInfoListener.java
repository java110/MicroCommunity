 ...
 */
@Java110Listener("deleteRepairInfoListener")
@Transactional
public class DeleteRepairInfoListener extends AbstractRepairBusinessServiceDataFlowListener {

    private final static Logger logger = LoggerFactory.getLogger(DeleteRepairInfoListener.class);
    @Autowired
    IRepairServiceDao repairServiceDaoImpl;
    ...
    public String getBusinessTypeCd() {
        return BusinessTypeConstant.BUSINESS_TYPE_DELETE_REPAIR;
    }
     ...
     */
    private void doBusinessRepair(AppBusiness business, JSONObject businessRepair) {
