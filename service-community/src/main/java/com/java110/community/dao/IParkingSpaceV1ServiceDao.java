 ...
 */
public interface IParkingSpaceV1ServiceDao {
     ...
     */
    int saveParkingSpaceInfo(Map info) throws DAOException;
     ...
     * @throws DAOException DAO异常
     */
    int updateParkingSpaceInfo(Map info) throws DAOException;
