...
/**
 * 类表述：保存
 * 服务编码：maintainanceTaskDetail.saveMaintainanceTaskDetail
 * 请求路劲：/app/maintainanceTaskDetail.SaveMaintainanceTaskDetail
 ...
 */
@Java110Cmd(serviceCode = "maintainanceTaskDetail.saveMaintainanceTaskDetail")
public class SaveMaintainanceTaskDetailCmd extends Cmd {

    private static Logger logger = LoggerFactory.getLogger(SaveMaintainanceTaskDetailCmd.class);
...
Assert.hasKeyAndValue(reqJson, "state", "请求报文中未包含state");
    ...
    public void doCmd(CmdEvent event, ICmdDataFlowContext cmdDataFlowContext, JSONObject reqJson) throws CmdException {
       ...
       MaintainanceTaskDetailPo maintainanceTaskDetailPo = BeanConvertUtil.covertBean(reqJson, MaintainanceTaskDetailPo.class);
        maintainanceTaskDetailPo.setTaskDetailId(GenerateCodeFactory.getGeneratorId(CODE_PREFIX_ID));
        int flag = maintainanceTaskDetailV1InnerServiceSMOImpl.saveMaintainanceTaskDetail(maintainanceTaskDetailPo);
