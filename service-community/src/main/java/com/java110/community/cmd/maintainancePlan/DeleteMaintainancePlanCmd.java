...
/**
 * 类表述：删除
 * 服务编码：maintainancePlan.deleteMaintainancePlan
 * 请求路劲：/app/maintainancePlan.DeleteMaintainancePlan
 ...
 */
@Java110Cmd(serviceCode = "maintainancePlan.deleteMaintainancePlan")
public class DeleteMaintainancePlanCmd extends Cmd {
    private static Logger logger = LoggerFactory.getLogger(DeleteMaintainancePlanCmd.class);
    ...
    public void doCmd(CmdEvent event, ICmdDataFlowContext cmdDataFlowContext, JSONObject reqJson) throws CmdException {
        ...
        int flag = maintainancePlanV1InnerServiceSMOImpl.deleteMaintainancePlan(maintainancePlanPo);
