 ...
 */
@RestController
public class InspectionPlanStaffV1InnerServiceSMOImpl extends BaseServiceSMO implements IInspectionPlanStaffV1InnerServiceSMO {

    @Autowired
    private IInspectionPlanStaffV1ServiceDao inspectionPlanStaffV1ServiceDaoImpl;


    @Override
    public int saveInspectionPlanStaff(@RequestBody InspectionPlanStaffPo inspectionPlanStaffPo) {
        int saveFlag = inspectionPlanStaffV1ServiceDaoImpl.saveInspectionPlanStaffInfo(BeanConvertUtil.beanCovertMap(inspectionPlanStaffPo));
        return saveFlag;
    }

    @Override
    public int updateInspectionPlanStaff(@RequestBody InspectionPlanStaffPo inspectionPlanStaffPo) {
        int saveFlag = inspectionPlanStaffV1ServiceDaoImpl.updateInspectionPlanStaffInfo(BeanConvertUtil.beanCovertMap(inspectionPlanStaffPo));
        return saveFlag;
    }

    @Override
    public int deleteInspectionPlanStaff(@RequestBody InspectionPlanStaffPo inspectionPlanStaffPo) {
        inspectionPlanStaffPo.setStatusCd("1");
        int saveFlag = inspectionPlanStaffV1ServiceDaoImpl.updateInspectionPlanStaffInfo(BeanConvertUtil.beanCovertMap(inspectionPlanStaffPo));
        return saveFlag;
    }
    ...
    public List<InspectionPlanStaffDto> queryInspectionPlanStaffs(@RequestBody InspectionPlanStaffDto inspectionPlanStaffDto) {
        ...
        List<InspectionPlanStaffDto> inspectionPlanStaffs = BeanConvertUtil.covertBeanList(inspectionPlanStaffV1ServiceDaoImpl.getInspectionPlanStaffInfo(BeanConvertUtil.beanCovertMap(inspectionPlanStaffDto)), InspectionPlanStaffDto.class);
