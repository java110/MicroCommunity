 ...
 */
public interface IUserQuestionAnswerValueV1ServiceDao {
     ...
     */
    int saveUserQuestionAnswerValueInfo(Map info) throws DAOException;
     ...
     * @throws DAOException DAO异常
     */
    int updateUserQuestionAnswerValueInfo(Map info) throws DAOException;
