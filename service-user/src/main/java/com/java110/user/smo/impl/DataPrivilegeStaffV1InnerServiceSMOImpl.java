 ...
 */
@RestController
public class DataPrivilegeStaffV1InnerServiceSMOImpl extends BaseServiceSMO implements IDataPrivilegeStaffV1InnerServiceSMO {

    @Autowired
    private IDataPrivilegeStaffV1ServiceDao dataPrivilegeStaffV1ServiceDaoImpl;


    @Override
    public int saveDataPrivilegeStaff(@RequestBody  DataPrivilegeStaffPo dataPrivilegeStaffPo) {
        int saveFlag = dataPrivilegeStaffV1ServiceDaoImpl.saveDataPrivilegeStaffInfo(BeanConvertUtil.beanCovertMap(dataPrivilegeStaffPo));
        return saveFlag;
    }

     @Override
    public int updateDataPrivilegeStaff(@RequestBody  DataPrivilegeStaffPo dataPrivilegeStaffPo) {
        int saveFlag = dataPrivilegeStaffV1ServiceDaoImpl.updateDataPrivilegeStaffInfo(BeanConvertUtil.beanCovertMap(dataPrivilegeStaffPo));
        return saveFlag;
    }

     @Override
    public int deleteDataPrivilegeStaff(@RequestBody  DataPrivilegeStaffPo dataPrivilegeStaffPo) {
       dataPrivilegeStaffPo.setStatusCd("1");
       int saveFlag = dataPrivilegeStaffV1ServiceDaoImpl.updateDataPrivilegeStaffInfo(BeanConvertUtil.beanCovertMap(dataPrivilegeStaffPo));
       return saveFlag;
    }

    @Override
    public List<DataPrivilegeStaffDto> queryDataPrivilegeStaffs(@RequestBody  DataPrivilegeStaffDto dataPrivilegeStaffDto) {
        ...
        List<DataPrivilegeStaffDto> dataPrivilegeStaffs = BeanConvertUtil.covertBeanList(dataPrivilegeStaffV1ServiceDaoImpl.getDataPrivilegeStaffInfo(BeanConvertUtil.beanCovertMap(dataPrivilegeStaffDto)), DataPrivilegeStaffDto.class);

        return dataPrivilegeStaffs;
    }
