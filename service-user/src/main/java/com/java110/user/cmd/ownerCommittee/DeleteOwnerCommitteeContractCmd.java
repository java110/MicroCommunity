...
/**
 * 类表述：删除
 * 服务编码：ownerCommitteeContract.deleteOwnerCommitteeContract
 * 请求路劲：/app/ownerCommitteeContract.DeleteOwnerCommitteeContract
 ...
 */
@Java110Cmd(serviceCode = "ownerCommittee.deleteOwnerCommitteeContract")
public class DeleteOwnerCommitteeContractCmd extends Cmd {
    private static Logger logger = LoggerFactory.getLogger(DeleteOwnerCommitteeContractCmd.class);
    ...
    public void doCmd(CmdEvent event, ICmdDataFlowContext cmdDataFlowContext, JSONObject reqJson) throws CmdException {
        ...
        int flag = ownerCommitteeContractV1InnerServiceSMOImpl.deleteOwnerCommitteeContract(ownerCommitteeContractPo);
