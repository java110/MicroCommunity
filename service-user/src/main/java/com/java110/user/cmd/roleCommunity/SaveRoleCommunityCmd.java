 ...
 */
@Java110Cmd(serviceCode = "roleCommunity.saveRoleCommunity")
public class SaveRoleCommunityCmd extends Cmd {

    private static Logger logger = LoggerFactory.getLogger(SaveRoleCommunityCmd.class);
