...
/**
 * 类表述：删除
 * 服务编码：userQuestionAnswer.deleteUserQuestionAnswer
 * 请求路劲：/app/userQuestionAnswer.DeleteUserQuestionAnswer
 ...
 */
@Java110Cmd(serviceCode = "userQuestionAnswer.deleteUserQuestionAnswer")
public class DeleteUserQuestionAnswerCmd extends Cmd {
  private static Logger logger = LoggerFactory.getLogger(DeleteUserQuestionAnswerCmd.class);
...
Assert.hasKeyAndValue(reqJson, "communityId", "communityId不能为空");
    ...
    public void doCmd(CmdEvent event, ICmdDataFlowContext cmdDataFlowContext, JSONObject reqJson) throws CmdException {
       ...
       UserQuestionAnswerPo userQuestionAnswerPo = BeanConvertUtil.covertBean(reqJson, UserQuestionAnswerPo.class);
        int flag = userQuestionAnswerV1InnerServiceSMOImpl.deleteUserQuestionAnswer(userQuestionAnswerPo);
