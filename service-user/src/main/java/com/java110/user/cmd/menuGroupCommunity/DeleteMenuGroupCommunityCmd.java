...
/**
 * 类表述：删除
 * 服务编码：menuGroupCommunity.deleteMenuGroupCommunity
 * 请求路劲：/app/menuGroupCommunity.DeleteMenuGroupCommunity
 ...
 */
@Java110Cmd(serviceCode = "menuGroupCommunity.deleteMenuGroupCommunity")
public class DeleteMenuGroupCommunityCmd extends AbstractServiceCmdListener {
  private static Logger logger = LoggerFactory.getLogger(DeleteMenuGroupCommunityCmd.class);
