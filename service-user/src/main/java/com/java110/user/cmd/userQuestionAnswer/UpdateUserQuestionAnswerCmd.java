...
/**
 * 类表述：更新
 * 服务编码：userQuestionAnswer.updateUserQuestionAnswer
 * 请求路劲：/app/userQuestionAnswer.UpdateUserQuestionAnswer
 ...
 */
@Java110Cmd(serviceCode = "userQuestionAnswer.updateUserQuestionAnswer")
public class UpdateUserQuestionAnswerCmd extends Cmd {

  private static Logger logger = LoggerFactory.getLogger(UpdateUserQuestionAnswerCmd.class);
...
Assert.hasKeyAndValue(reqJson, "communityId", "communityId不能为空");
    ...
    public void doCmd(CmdEvent event, ICmdDataFlowContext cmdDataFlowContext, JSONObject reqJson) throws CmdException {
       ...
       UserQuestionAnswerPo userQuestionAnswerPo = BeanConvertUtil.covertBean(reqJson, UserQuestionAnswerPo.class);
        int flag = userQuestionAnswerV1InnerServiceSMOImpl.updateUserQuestionAnswer(userQuestionAnswerPo);
