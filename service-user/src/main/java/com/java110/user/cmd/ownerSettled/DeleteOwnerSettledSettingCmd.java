...
/**
 * 类表述：删除
 * 服务编码：ownerSettledSetting.deleteOwnerSettledSetting
 * 请求路劲：/app/ownerSettledSetting.DeleteOwnerSettledSetting
 ...
 */
@Java110Cmd(serviceCode = "ownerSettled.deleteOwnerSettledSetting")
public class DeleteOwnerSettledSettingCmd extends Cmd {
    private static Logger logger = LoggerFactory.getLogger(DeleteOwnerSettledSettingCmd.class);
    ...
    public void doCmd(CmdEvent event, ICmdDataFlowContext cmdDataFlowContext, JSONObject reqJson) throws CmdException {
        ...
        int flag = ownerSettledSettingV1InnerServiceSMOImpl.deleteOwnerSettledSetting(ownerSettledSettingPo);
