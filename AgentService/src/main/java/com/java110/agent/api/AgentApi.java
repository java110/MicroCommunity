...
public class AgentApi extends BaseController {
    ...
    @Autowired
    IAgentServiceSMO agentServiceSMOImpl;

    @RequestMapping(path = "/agentApi/service",method= RequestMethod.GET)
     ...
     * @return
     */
    @RequestMapping(path = "/agentApi/service",method= RequestMethod.POST)
