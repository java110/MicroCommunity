...
import com.java110.agent.smo.IAgentServiceSMO;
 ...
 */
public class AgentServiceKafka extends BaseController {

    private final static Logger logger = LoggerFactory.getLogger(AgentServiceKafka.class);

    @Autowired
    private IAgentServiceSMO agentServiceSMOImpl;

    @KafkaListener(topics = {"agentServiceTopic"})
    public void listen(ConsumerRecord<?, ?> record) {
        ...
        try {
            ...
            responseJson = agentServiceSMOImpl.service(businessServiceDataFlow);
    ...
    public IAgentServiceSMO getAgentServiceSMOImpl() {
        return agentServiceSMOImpl;
    }

    public void setAgentServiceSMOImpl(IAgentServiceSMO agentServiceSMOImpl) {
        this.agentServiceSMOImpl = agentServiceSMOImpl;
    }
}
