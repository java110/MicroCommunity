...
/**
 * 类表述：保存
 * 服务编码：marketGoodsItem.saveMarketGoodsItem
 * 请求路劲：/app/marketGoodsItem.SaveMarketGoodsItem
 ...
 */
@Java110Cmd(serviceCode = "marketGoods.saveMarketGoodsItem")
public class SaveMarketGoodsItemCmd extends Cmd {

    private static Logger logger = LoggerFactory.getLogger(SaveMarketGoodsItemCmd.class);
