...
/**
 * 类表述：保存
 * 服务编码：marketPic.saveMarketPic
 * 请求路劲：/app/marketPic.SaveMarketPic
 ...
 */
@Java110Cmd(serviceCode = "marketPic.saveMarketPic")
public class SaveMarketPicCmd extends Cmd {

    private static Logger logger = LoggerFactory.getLogger(SaveMarketPicCmd.class);
