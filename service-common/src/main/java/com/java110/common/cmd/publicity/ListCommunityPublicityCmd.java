 ...
 */
package com.java110.common.cmd.publicity;
...
/**
 * 类表述：查询
 * 服务编码：communityPublicity.listCommunityPublicity
 * 请求路劲：/app/communityPublicity.ListCommunityPublicity
 ...
 */
@Java110Cmd(serviceCode = "publicity.listCommunityPublicity")
public class ListCommunityPublicityCmd extends Cmd {

    private static Logger logger = LoggerFactory.getLogger(ListCommunityPublicityCmd.class);
    @Autowired
    ...
    public void doCmd(CmdEvent event, ICmdDataFlowContext cmdDataFlowContext, JSONObject reqJson) throws CmdException {
        ...
        CommunityPublicityDto communityPublicityDto = BeanConvertUtil.covertBean(reqJson, CommunityPublicityDto.class);

        int count = communityPublicityV1InnerServiceSMOImpl.queryCommunityPublicitysCount(communityPublicityDto);

        List<CommunityPublicityDto> communityPublicityDtos = null;
        ...
        ResultVo resultVo = new ResultVo((int) Math.ceil((double) count / (double) reqJson.getInteger("row")), count, communityPublicityDtos);
