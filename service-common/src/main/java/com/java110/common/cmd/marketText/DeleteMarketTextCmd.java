...
/**
 * 类表述：删除
 * 服务编码：marketText.deleteMarketText
 * 请求路劲：/app/marketText.DeleteMarketText
 ...
 */
@Java110Cmd(serviceCode = "marketText.deleteMarketText")
public class DeleteMarketTextCmd extends Cmd {
    private static Logger logger = LoggerFactory.getLogger(DeleteMarketTextCmd.class);
    ...
    public void doCmd(CmdEvent event, ICmdDataFlowContext cmdDataFlowContext, JSONObject reqJson) throws CmdException {
        ...
        int flag = marketTextV1InnerServiceSMOImpl.deleteMarketText(marketTextPo);
