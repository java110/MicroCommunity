...
/**
 * 类表述：保存
 * 服务编码：carInoutPayment.saveCarInoutPayment
 * 请求路劲：/app/carInoutPayment.SaveCarInoutPayment
 ...
 */
@Java110Cmd(serviceCode = "carInoutPayment.saveCarInoutPayment")
public class SaveCarInoutPaymentCmd extends AbstractServiceCmdListener {

    private static Logger logger = LoggerFactory.getLogger(SaveCarInoutPaymentCmd.class);
    ...
    public void doCmd(CmdEvent event, ICmdDataFlowContext cmdDataFlowContext, JSONObject reqJson) throws CmdException {
        ...
        carInoutPaymentPo.setPaymentId(GenerateCodeFactory.getGeneratorId(CODE_PREFIX_ID));
