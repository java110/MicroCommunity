...
/**
 * 类表述：更新
 * 服务编码：marketText.updateMarketText
 * 请求路劲：/app/marketText.UpdateMarketText
 ...
 */
@Java110Cmd(serviceCode = "marketText.updateMarketText")
public class UpdateMarketTextCmd extends Cmd {

    private static Logger logger = LoggerFactory.getLogger(UpdateMarketTextCmd.class);
    ...
    public void doCmd(CmdEvent event, ICmdDataFlowContext cmdDataFlowContext, JSONObject reqJson) throws CmdException {
        ...
        int flag = marketTextV1InnerServiceSMOImpl.updateMarketText(marketTextPo);
