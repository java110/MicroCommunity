...
/**
 * 类表述：删除
 * 服务编码：attendanceClassesStaff.deleteAttendanceClassesStaff
 * 请求路劲：/app/attendanceClassesStaff.DeleteAttendanceClassesStaff
 ...
 */
@Java110Cmd(serviceCode = "attendanceClasses.deleteAttendanceClassesStaff")
public class DeleteAttendanceClassesStaffCmd extends Cmd {
    private static Logger logger = LoggerFactory.getLogger(DeleteAttendanceClassesStaffCmd.class);
    ...
    public void doCmd(CmdEvent event, ICmdDataFlowContext cmdDataFlowContext, JSONObject reqJson) throws CmdException {
        ...
        int flag = attendanceClassesStaffV1InnerServiceSMOImpl.deleteAttendanceClassesStaff(attendanceClassesStaffPo);
