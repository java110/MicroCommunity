...
/**
 * 类表述：删除
 * 服务编码：meterMachineFactory.deleteMeterMachineFactory
 * 请求路劲：/app/meterMachineFactory.DeleteMeterMachineFactory
 ...
 */
@Java110Cmd(serviceCode = "meterMachine.deleteMeterMachineFactory")
public class DeleteMeterMachineFactoryCmd extends Cmd {
    private static Logger logger = LoggerFactory.getLogger(DeleteMeterMachineFactoryCmd.class);
    ...
    public void doCmd(CmdEvent event, ICmdDataFlowContext cmdDataFlowContext, JSONObject reqJson) throws CmdException {
        ...
        int flag = meterMachineFactoryV1InnerServiceSMOImpl.deleteMeterMachineFactory(meterMachineFactoryPo);
