...
/**
 * 类表述：查询
 * 服务编码：carInout.listCarInout
 * 请求路劲：/app/carInout.ListCarInout
 ...
 */
@Java110Cmd(serviceCode = "carInout.listCarInout")
public class ListCarInoutCmd extends AbstractServiceCmdListener {

    private static Logger logger = LoggerFactory.getLogger(ListCarInoutCmd.class);
    @Autowired
