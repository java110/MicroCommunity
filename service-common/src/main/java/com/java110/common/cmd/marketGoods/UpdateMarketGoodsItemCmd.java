...
/**
 * 类表述：更新
 * 服务编码：marketGoodsItem.updateMarketGoodsItem
 * 请求路劲：/app/marketGoodsItem.UpdateMarketGoodsItem
 ...
 */
@Java110Cmd(serviceCode = "marketGoods.updateMarketGoodsItem")
public class UpdateMarketGoodsItemCmd extends Cmd {

  private static Logger logger = LoggerFactory.getLogger(UpdateMarketGoodsItemCmd.class);
    ...
    public void doCmd(CmdEvent event, ICmdDataFlowContext cmdDataFlowContext, JSONObject reqJson) throws CmdException {
       ...
       MarketGoodsItemPo marketGoodsItemPo = BeanConvertUtil.covertBean(reqJson, MarketGoodsItemPo.class);
        int flag = marketGoodsItemV1InnerServiceSMOImpl.updateMarketGoodsItem(marketGoodsItemPo);
