...
/**
 * 类表述：删除
 * 服务编码：marketSms.deleteMarketSms
 * 请求路劲：/app/marketSms.DeleteMarketSms
 ...
 */
@Java110Cmd(serviceCode = "marketSms.deleteMarketSms")
public class DeleteMarketSmsCmd extends Cmd {
    private static Logger logger = LoggerFactory.getLogger(DeleteMarketSmsCmd.class);
    ...
    public void doCmd(CmdEvent event, ICmdDataFlowContext cmdDataFlowContext, JSONObject reqJson) throws CmdException {
        ...
        int flag = marketSmsV1InnerServiceSMOImpl.deleteMarketSms(marketSmsPo);
