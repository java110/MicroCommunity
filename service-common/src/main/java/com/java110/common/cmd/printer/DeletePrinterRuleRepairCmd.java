...
/**
 * 类表述：删除
 * 服务编码：printerRuleRepair.deletePrinterRuleRepair
 * 请求路劲：/app/printerRuleRepair.DeletePrinterRuleRepair
 ...
 */
@Java110Cmd(serviceCode = "printer.deletePrinterRuleRepair")
public class DeletePrinterRuleRepairCmd extends Cmd {
    private static Logger logger = LoggerFactory.getLogger(DeletePrinterRuleRepairCmd.class);
    ...
    public void doCmd(CmdEvent event, ICmdDataFlowContext cmdDataFlowContext, JSONObject reqJson) throws CmdException {
        ...
        int flag = printerRuleRepairV1InnerServiceSMOImpl.deletePrinterRuleRepair(printerRuleRepairPo);
