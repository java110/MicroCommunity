 ...
 * 请求路劲：/app/itemReleaseType.UpdateItemReleaseType
 ...
 */
@Java110Cmd(serviceCode = "itemRelease.updateItemReleaseType")
public class UpdateItemReleaseTypeCmd extends Cmd {

    private static Logger logger = LoggerFactory.getLogger(UpdateItemReleaseTypeCmd.class);
    ...
    public void doCmd(CmdEvent event, ICmdDataFlowContext cmdDataFlowContext, JSONObject reqJson) throws CmdException {
        ...
        int flag = itemReleaseTypeV1InnerServiceSMOImpl.updateItemReleaseType(itemReleaseTypePo);
