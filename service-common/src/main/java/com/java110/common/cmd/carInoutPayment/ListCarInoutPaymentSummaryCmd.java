 ...
 */
@Java110Cmd(serviceCode = "carInoutPayment.listCarInoutPaymentSummary")
public class ListCarInoutPaymentSummaryCmd extends Cmd {

    private static Logger logger = LoggerFactory.getLogger(ListCarInoutPaymentSummaryCmd.class);
    @Autowired
    ...
    public void doCmd(CmdEvent event, ICmdDataFlowContext cmdDataFlowContext, JSONObject reqJson) throws CmdException {
        ...
        ResultVo resultVo = new ResultVo(1, 1, carInoutPaymentDtos);
