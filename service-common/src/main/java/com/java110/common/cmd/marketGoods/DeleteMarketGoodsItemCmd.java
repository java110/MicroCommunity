...
/**
 * 类表述：删除
 * 服务编码：marketGoodsItem.deleteMarketGoodsItem
 * 请求路劲：/app/marketGoodsItem.DeleteMarketGoodsItem
 ...
 */
@Java110Cmd(serviceCode = "marketGoods.deleteMarketGoodsItem")
public class DeleteMarketGoodsItemCmd extends Cmd {
  private static Logger logger = LoggerFactory.getLogger(DeleteMarketGoodsItemCmd.class);
    ...
    public void doCmd(CmdEvent event, ICmdDataFlowContext cmdDataFlowContext, JSONObject reqJson) throws CmdException {
       ...
       MarketGoodsItemPo marketGoodsItemPo = BeanConvertUtil.covertBean(reqJson, MarketGoodsItemPo.class);
        int flag = marketGoodsItemV1InnerServiceSMOImpl.deleteMarketGoodsItem(marketGoodsItemPo);
