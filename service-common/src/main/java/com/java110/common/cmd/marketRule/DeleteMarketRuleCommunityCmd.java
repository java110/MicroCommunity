...
/**
 * 类表述：删除
 * 服务编码：marketRuleCommunity.deleteMarketRuleCommunity
 * 请求路劲：/app/marketRuleCommunity.DeleteMarketRuleCommunity
 ...
 */
@Java110Cmd(serviceCode = "marketRule.deleteMarketRuleCommunity")
public class DeleteMarketRuleCommunityCmd extends Cmd {
  private static Logger logger = LoggerFactory.getLogger(DeleteMarketRuleCommunityCmd.class);
    ...
    public void doCmd(CmdEvent event, ICmdDataFlowContext cmdDataFlowContext, JSONObject reqJson) throws CmdException {
       ...
       MarketRuleCommunityPo marketRuleCommunityPo = BeanConvertUtil.covertBean(reqJson, MarketRuleCommunityPo.class);
        int flag = marketRuleCommunityV1InnerServiceSMOImpl.deleteMarketRuleCommunity(marketRuleCommunityPo);
