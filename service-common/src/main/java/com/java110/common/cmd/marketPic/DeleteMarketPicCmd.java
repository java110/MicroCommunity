...
/**
 * 类表述：删除
 * 服务编码：marketPic.deleteMarketPic
 * 请求路劲：/app/marketPic.DeleteMarketPic
 ...
 */
@Java110Cmd(serviceCode = "marketPic.deleteMarketPic")
public class DeleteMarketPicCmd extends Cmd {
    private static Logger logger = LoggerFactory.getLogger(DeleteMarketPicCmd.class);
    ...
    public void doCmd(CmdEvent event, ICmdDataFlowContext cmdDataFlowContext, JSONObject reqJson) throws CmdException {
        ...
        int flag = marketPicV1InnerServiceSMOImpl.deleteMarketPic(marketPicPo);
