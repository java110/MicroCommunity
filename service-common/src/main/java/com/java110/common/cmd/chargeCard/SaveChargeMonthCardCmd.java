...
/**
 * 类表述：保存
 * 服务编码：chargeMonthCard.saveChargeMonthCard
 * 请求路劲：/app/chargeMonthCard.SaveChargeMonthCard
 ...
 */
@Java110Cmd(serviceCode = "chargeCard.saveChargeMonthCard")
public class SaveChargeMonthCardCmd extends Cmd {

    private static Logger logger = LoggerFactory.getLogger(SaveChargeMonthCardCmd.class);
