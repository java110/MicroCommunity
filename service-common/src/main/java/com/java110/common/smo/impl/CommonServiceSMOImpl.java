...
import com.java110.common.smo.ICommonServiceSMO;
...
@Transactional
public class CommonServiceSMOImpl extends BaseServiceSMO implements ICommonServiceSMO {

    private static Logger logger = LoggerFactory.getLogger(CommonServiceSMOImpl.class);
    ...
    public JSONObject service(BusinessServiceDataFlow businessServiceDataFlow) throws SMOException {
        try {
            ...
            Assert.notEmpty(businessServiceDataFlow.getResJson(), "common服务[" + businessServiceDataFlow.getCurrentBusiness().getServiceCode() + "]没有返回内容");
        } catch (Exception e) {
            logger.error("common服务处理异常", e);
            throw new SMOException(ResponseConstant.RESULT_PARAM_ERROR, "common服务处理异常" + e.getMessage());
        } finally {
