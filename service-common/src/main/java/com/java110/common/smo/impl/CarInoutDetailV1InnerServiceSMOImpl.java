 ...
 */
@RestController
public class CarInoutDetailV1InnerServiceSMOImpl extends BaseServiceSMO implements ICarInoutDetailV1InnerServiceSMO {
    ...
    public int saveCarInoutDetail(@RequestBody CarInoutDetailPo carInoutDetailPo) {
     ...
     @Override
    public int updateCarInoutDetail(@RequestBody  CarInoutDetailPo carInoutDetailPo) {
        int saveFlag = carInoutDetailV1ServiceDaoImpl.updateCarInoutDetailInfo(BeanConvertUtil.beanCovertMap(carInoutDetailPo));
        return saveFlag;
    }

     @Override
    public int deleteCarInoutDetail(@RequestBody  CarInoutDetailPo carInoutDetailPo) {
       carInoutDetailPo.setStatusCd("1");
       int saveFlag = carInoutDetailV1ServiceDaoImpl.updateCarInoutDetailInfo(BeanConvertUtil.beanCovertMap(carInoutDetailPo));
       return saveFlag;
    }
    ...
    public List<CarInoutDetailDto> queryCarInoutDetails(@RequestBody  CarInoutDetailDto carInoutDetailDto) {
        ...
        List<CarInoutDetailDto> carInoutDetails = BeanConvertUtil.covertBeanList(carInoutDetailV1ServiceDaoImpl.getCarInoutDetailInfo(BeanConvertUtil.beanCovertMap(carInoutDetailDto)), CarInoutDetailDto.class);
    ...
    public int queryCarInoutDetailsCount(@RequestBody CarInoutDetailDto carInoutDetailDto) {
        return carInoutDetailV1ServiceDaoImpl.queryCarInoutDetailsCount(BeanConvertUtil.beanCovertMap(carInoutDetailDto));    }
