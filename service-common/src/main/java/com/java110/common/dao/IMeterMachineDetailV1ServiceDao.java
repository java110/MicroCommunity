 ...
 */
public interface IMeterMachineDetailV1ServiceDao {
    ...
    /**
     * 查询智能水电表明细信息（instance过程）
     * 根据bId 查询智能水电表明细信息
     * @param info bId 信息
     * @return 智能水电表明细信息
     * @throws DAOException DAO异常
     */
    List<Map> getMeterMachineDetailInfo(Map info) throws DAOException;
     ...
     * @throws DAOException DAO异常
     */
    int updateMeterMachineDetailInfo(Map info) throws DAOException;
