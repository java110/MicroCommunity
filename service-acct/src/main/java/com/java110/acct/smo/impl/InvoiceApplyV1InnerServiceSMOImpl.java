...
import com.java110.acct.dao.IInvoiceApplyV1ServiceDao;
...
public class InvoiceApplyV1InnerServiceSMOImpl extends BaseServiceSMO implements IInvoiceApplyV1InnerServiceSMO {
    ...
    @Override
    public int queryInvoiceApplysCount(@RequestBody InvoiceApplyDto invoiceApplyDto) {
        return invoiceApplyV1ServiceDaoImpl.queryInvoiceApplysCount(BeanConvertUtil.beanCovertMap(invoiceApplyDto));    }
