 ...
 */
@RestController
public class CouponRuleCppsV1InnerServiceSMOImpl extends BaseServiceSMO implements ICouponRuleCppsV1InnerServiceSMO {

    @Autowired
    private ICouponRuleCppsV1ServiceDao couponRuleCppsV1ServiceDaoImpl;
    ...
    @Override
    public List<CouponRuleCppsDto> queryCouponRuleCppss(@RequestBody  CouponRuleCppsDto couponRuleCppsDto) {

        //校验是否传了 分页信息

        int page = couponRuleCppsDto.getPage();
    ...
    @Override
    public int queryCouponRuleCppssCount(@RequestBody CouponRuleCppsDto couponRuleCppsDto) {
        return couponRuleCppsV1ServiceDaoImpl.queryCouponRuleCppssCount(BeanConvertUtil.beanCovertMap(couponRuleCppsDto));    }
