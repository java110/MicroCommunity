...
public class InvoiceApplyItemV1InnerServiceSMOImpl extends BaseServiceSMO implements IInvoiceApplyItemV1InnerServiceSMO {
    ...
    public int deleteInvoiceApplyItem(@RequestBody  InvoiceApplyItemPo invoiceApplyItemPo) {
       invoiceApplyItemPo.setStatusCd("1");
       int saveFlag = invoiceApplyItemV1ServiceDaoImpl.updateInvoiceApplyItemInfo(BeanConvertUtil.beanCovertMap(invoiceApplyItemPo));
       return saveFlag;
    }

    @Override
    public List<InvoiceApplyItemDto> queryInvoiceApplyItems(@RequestBody  InvoiceApplyItemDto invoiceApplyItemDto) {

        //校验是否传了 分页信息

        int page = invoiceApplyItemDto.getPage();
    ...
    @Override
    public int queryInvoiceApplyItemsCount(@RequestBody InvoiceApplyItemDto invoiceApplyItemDto) {
        return invoiceApplyItemV1ServiceDaoImpl.queryInvoiceApplyItemsCount(BeanConvertUtil.beanCovertMap(invoiceApplyItemDto));    }
