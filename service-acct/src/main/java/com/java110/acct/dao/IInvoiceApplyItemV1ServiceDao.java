 ...
 */
public interface IInvoiceApplyItemV1ServiceDao {
    ...
    /**
     * 查询发票申请项信息（instance过程）
     * 根据bId 查询发票申请项信息
     * @param info bId 信息
     * @return 发票申请项信息
     * @throws DAOException DAO异常
     */
    List<Map> getInvoiceApplyItemInfo(Map info) throws DAOException;
     ...
     * @throws DAOException DAO异常
     */
    int updateInvoiceApplyItemInfo(Map info) throws DAOException;
