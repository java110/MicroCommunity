 ...
 */
@Service("couponPropertyPoolDetailV1ServiceDaoImpl")
public class CouponPropertyPoolDetailV1ServiceDaoImpl extends BaseServiceDao implements ICouponPropertyPoolDetailV1ServiceDao {

    private static Logger logger = LoggerFactory.getLogger(CouponPropertyPoolDetailV1ServiceDaoImpl.class);
     ...
     */
    @Override
    public int saveCouponPropertyPoolDetailInfo(Map info) throws DAOException {
        logger.debug("保存 saveCouponPropertyPoolDetailInfo 入参 info : {}",info);

        int saveFlag = sqlSessionTemplate.insert("couponPropertyPoolDetailV1ServiceDaoImpl.saveCouponPropertyPoolDetailInfo",info);
     ...
     */
    @Override
    public int updateCouponPropertyPoolDetailInfo(Map info) throws DAOException {
        logger.debug("修改 updateCouponPropertyPoolDetailInfo 入参 info : {}",info);

        int saveFlag = sqlSessionTemplate.update("couponPropertyPoolDetailV1ServiceDaoImpl.updateCouponPropertyPoolDetailInfo",info);
