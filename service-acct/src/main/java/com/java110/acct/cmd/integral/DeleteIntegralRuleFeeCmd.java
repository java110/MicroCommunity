...
/**
 * 类表述：删除
 * 服务编码：integralRuleFee.deleteIntegralRuleFee
 * 请求路劲：/app/integralRuleFee.DeleteIntegralRuleFee
 ...
 */
@Java110Cmd(serviceCode = "integral.deleteIntegralRuleFee")
public class DeleteIntegralRuleFeeCmd extends Cmd {
    private static Logger logger = LoggerFactory.getLogger(DeleteIntegralRuleFeeCmd.class);
    ...
    public void doCmd(CmdEvent event, ICmdDataFlowContext cmdDataFlowContext, JSONObject reqJson) throws CmdException {
        ...
        int flag = integralRuleFeeV1InnerServiceSMOImpl.deleteIntegralRuleFee(integralRuleFeePo);
