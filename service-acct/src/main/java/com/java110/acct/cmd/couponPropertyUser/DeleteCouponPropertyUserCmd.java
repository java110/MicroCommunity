...
/**
 * 类表述：删除
 * 服务编码：couponPropertyUser.deleteCouponPropertyUser
 * 请求路劲：/app/couponPropertyUser.DeleteCouponPropertyUser
 ...
 */
@Java110Cmd(serviceCode = "couponPropertyUser.deleteCouponPropertyUser")
public class DeleteCouponPropertyUserCmd extends Cmd {
  private static Logger logger = LoggerFactory.getLogger(DeleteCouponPropertyUserCmd.class);
...
Assert.hasKeyAndValue(reqJson, "communityId", "communityId不能为空");
    ...
    public void doCmd(CmdEvent event, ICmdDataFlowContext cmdDataFlowContext, JSONObject reqJson) throws CmdException {
       ...
       CouponPropertyUserPo couponPropertyUserPo = BeanConvertUtil.covertBean(reqJson, CouponPropertyUserPo.class);
        int flag = couponPropertyUserV1InnerServiceSMOImpl.deleteCouponPropertyUser(couponPropertyUserPo);
