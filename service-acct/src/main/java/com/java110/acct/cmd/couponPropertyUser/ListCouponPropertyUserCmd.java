 ...
 */
@Java110Cmd(serviceCode = "couponPropertyUser.listCouponPropertyUser")
public class ListCouponPropertyUserCmd extends Cmd {

  private static Logger logger = LoggerFactory.getLogger(ListCouponPropertyUserCmd.class);
    @Autowired
