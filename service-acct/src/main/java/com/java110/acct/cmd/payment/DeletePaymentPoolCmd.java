 ...
 */
@Java110Cmd(serviceCode = "payment.deletePaymentPool")
public class DeletePaymentPoolCmd extends Cmd {
    private static Logger logger = LoggerFactory.getLogger(DeletePaymentPoolCmd.class);
