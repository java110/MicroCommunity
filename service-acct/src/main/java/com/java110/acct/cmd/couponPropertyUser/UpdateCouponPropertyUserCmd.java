...
/**
 * 类表述：更新
 * 服务编码：couponPropertyUser.updateCouponPropertyUser
 * 请求路劲：/app/couponPropertyUser.UpdateCouponPropertyUser
 ...
 */
@Java110Cmd(serviceCode = "couponPropertyUser.updateCouponPropertyUser")
public class UpdateCouponPropertyUserCmd extends Cmd {

  private static Logger logger = LoggerFactory.getLogger(UpdateCouponPropertyUserCmd.class);
...
Assert.hasKeyAndValue(reqJson, "communityId", "communityId不能为空");
    ...
    public void doCmd(CmdEvent event, ICmdDataFlowContext cmdDataFlowContext, JSONObject reqJson) throws CmdException {
       ...
       CouponPropertyUserPo couponPropertyUserPo = BeanConvertUtil.covertBean(reqJson, CouponPropertyUserPo.class);
        int flag = couponPropertyUserV1InnerServiceSMOImpl.updateCouponPropertyUser(couponPropertyUserPo);
