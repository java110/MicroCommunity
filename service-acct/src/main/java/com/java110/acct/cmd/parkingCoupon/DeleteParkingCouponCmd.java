...
/**
 * 类表述：删除
 * 服务编码：parkingCoupon.deleteParkingCoupon
 * 请求路劲：/app/parkingCoupon.DeleteParkingCoupon
 ...
 */
@Java110Cmd(serviceCode = "parkingCoupon.deleteParkingCoupon")
public class DeleteParkingCouponCmd extends Cmd {
    private static Logger logger = LoggerFactory.getLogger(DeleteParkingCouponCmd.class);
    ...
    public void doCmd(CmdEvent event, ICmdDataFlowContext cmdDataFlowContext, JSONObject reqJson) throws CmdException {
        ...
        int flag = parkingCouponV1InnerServiceSMOImpl.deleteParkingCoupon(parkingCouponPo);
