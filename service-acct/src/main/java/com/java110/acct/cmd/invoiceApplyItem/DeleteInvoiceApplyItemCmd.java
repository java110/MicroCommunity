...
/**
 * 类表述：删除
 * 服务编码：invoiceApplyItem.deleteInvoiceApplyItem
 * 请求路劲：/app/invoiceApplyItem.DeleteInvoiceApplyItem
 ...
 */
@Java110Cmd(serviceCode = "invoiceApplyItem.deleteInvoiceApplyItem")
public class DeleteInvoiceApplyItemCmd extends Cmd {
    private static Logger logger = LoggerFactory.getLogger(DeleteInvoiceApplyItemCmd.class);
    ...
    public void doCmd(CmdEvent event, ICmdDataFlowContext cmdDataFlowContext, JSONObject reqJson) throws CmdException {
        ...
        int flag = invoiceApplyItemV1InnerServiceSMOImpl.deleteInvoiceApplyItem(invoiceApplyItemPo);
