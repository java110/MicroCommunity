...
/**
 * 类表述：删除
 * 服务编码：couponShopPoolDetail.deleteCouponShopPoolDetail
 * 请求路劲：/app/couponShopPoolDetail.DeleteCouponShopPoolDetail
 ...
 */
@Java110Cmd(serviceCode = "couponShopPoolDetail.deleteCouponShopPoolDetail")
public class DeleteCouponShopPoolDetailCmd extends AbstractServiceCmdListener {
    private static Logger logger = LoggerFactory.getLogger(DeleteCouponShopPoolDetailCmd.class);
    ...
    public void doCmd(CmdEvent event, ICmdDataFlowContext cmdDataFlowContext, JSONObject reqJson) throws CmdException {
        ...
        int flag = couponShopPoolDetailV1InnerServiceSMOImpl.deleteCouponShopPoolDetail(couponShopPoolDetailPo);
