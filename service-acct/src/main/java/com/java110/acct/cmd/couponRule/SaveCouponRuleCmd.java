...
/**
 * 类表述：保存
 * 服务编码：couponRule.saveCouponRule
 * 请求路劲：/app/couponRule.SaveCouponRule
 ...
 */
@Java110Cmd(serviceCode = "couponRule.saveCouponRule")
public class SaveCouponRuleCmd extends Cmd {

    private static Logger logger = LoggerFactory.getLogger(SaveCouponRuleCmd.class);
