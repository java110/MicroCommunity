...
/**
 * 类表述：更新
 * 服务编码：ownerInvoice.updateOwnerInvoice
 * 请求路劲：/app/ownerInvoice.UpdateOwnerInvoice
 ...
 */
@Java110Cmd(serviceCode = "ownerInvoice.updateOwnerInvoice")
public class UpdateOwnerInvoiceCmd extends Cmd {

    private static Logger logger = LoggerFactory.getLogger(UpdateOwnerInvoiceCmd.class);
    ...
    public void doCmd(CmdEvent event, ICmdDataFlowContext cmdDataFlowContext, JSONObject reqJson) throws CmdException {
        ...
        int flag = ownerInvoiceV1InnerServiceSMOImpl.updateOwnerInvoice(ownerInvoicePo);
