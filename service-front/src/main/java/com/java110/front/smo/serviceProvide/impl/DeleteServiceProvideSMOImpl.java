...
import com.java110.front.smo.serviceProvide.IDeleteServiceProvideSMO;
...
public class DeleteServiceProvideSMOImpl extends AbstractComponentSMO implements IDeleteServiceProvideSMO {
    ...
    protected ResponseEntity<String> doBusinessProcess(IPageData pd, JSONObject paramIn) {
        ...
        responseEntity = this.callCenterService(restTemplate, pd, paramIn.toJSONString(),
                ServiceConstant.SERVICE_API_URL + "/api/serviceProvide.deleteServiceProvide",
                HttpMethod.POST);
