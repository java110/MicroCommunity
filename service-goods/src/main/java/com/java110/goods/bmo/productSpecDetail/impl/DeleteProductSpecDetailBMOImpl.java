...
@Service("deleteProductSpecDetailBMOImpl")
public class DeleteProductSpecDetailBMOImpl implements IDeleteProductSpecDetailBMO {

    @Autowired
    private IProductSpecDetailInnerServiceSMO productSpecDetailInnerServiceSMOImpl;

    /**
     * @param productSpecDetailPo 数据
     * @return 订单服务能够接受的报文
     */
    @Java110Transactional
    public ResponseEntity<String> delete(ProductSpecDetailPo productSpecDetailPo) {

        int flag = productSpecDetailInnerServiceSMOImpl.deleteProductSpecDetail(productSpecDetailPo);
